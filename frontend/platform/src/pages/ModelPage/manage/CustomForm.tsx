...
const modelProviders = {
  ...
  zhipu: [
    ...
    },
    {
      ...
      type: "text",
      placeholder: "",
      default: "https://open.bigmodel.cn/hjapi/paas/v4/",
      required: true,
      key: "openai_api_base",
    },
  ],
  ...
  volcengine: [
    {
      label: "Base URL",
      type: "text",
      placeholder: "格式示例：https://ark.cn-beijing.volces.com/hjapi/v3",
      default: "https://ark.cn-beijing.volces.com/hjapi/v3",
      required: true,
      key: "base_url",
    },
    {
