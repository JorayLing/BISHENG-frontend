...
export default function SystemModelConfig({ data, onBack }) {
  ...
  return (
    <div className="px-2 py-4 size-full pb-20 relative overflow-y-auto">
      <div className="">
        ...
        <div className="px-4">
          <Tabs defaultValue="knowledge" className="flex flex-col">
            <TabsList className="w-[550px] m-auto">
              <TabsTrigger value="knowledge" className="w-[150px]">
                {t("model.knowledgeBaseModel")}
              </TabsTrigger>
              <TabsTrigger value="assis" className="w-[150px]">
                {t("model.assistantModel")}
              </TabsTrigger>
              <TabsTrigger value="evaluation" className="w-[150px]">
                {t("model.evaluationModel")}
              </TabsTrigger>
              <TabsTrigger value="workflow" className="w-[150px]">
                {t("model.workflowModel")}
              </TabsTrigger>
            </TabsList>
