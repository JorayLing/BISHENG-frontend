...
import {
  ToggleGroup,
  ToggleGroupItem,
} from "../../../components/bs-ui/toggle-group";
...
export default function FinetuneHead({
  onSearch,
  onFilter,
  rtClick,
  onCreate,
      ...
      <div className="flex gap-4">
        ...
        >
          ...
          <ToggleGroupItem value="4">
            {t("finetune.successful")}
          </ToggleGroupItem>
          <ToggleGroupItem value="1">
            {t("finetune.inProgress")}
          </ToggleGroupItem>
          <ToggleGroupItem value="2">
            {t("finetune.failedAborted")}
          </ToggleGroupItem>
        </ToggleGroup>
        ...
        <SearchInput
          ref={inputRef}
          placeholder={t("finetune.modelName")}
          onChange={useDebounce(handleSearch, 600, false)}
        ></SearchInput>
      </div>
      <div className="flex gap-4 mr-2">
        <Button className="dark:text-[#ECECEC]" onClick={onCreate}>
          {t("finetune.createTrainingTask")}
        </Button>
        <Button
          variant="black"
          className="dark:text-[#ECECEC] dark:bg-[#34353A]"
          onClick={rtClick}
        >
