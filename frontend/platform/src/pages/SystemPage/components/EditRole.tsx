        ...
        res.data.forEach((item) => {
          switch (item.type) {
            ...
            case 2:
              ...
              break;
            case 9:
              useFlows.push(item.third_id);
              break;
            case 3:
              manageLibs.push(Number(item.third_id));
              break;
            case 7:
              useTools.push(Number(item.third_id));
              break;
            case 5:
              useAssistant.push(item.third_id);
              break;
            case 99:
              useMenu.push(item.third_id);
              break;
          }
        });
        setForm({
              ...
              <TableRow>
                ...
                <TableCell className="text-center">
                  <Switch
                    ...
                    onCheckedChange={(bln) =>
                      switchDataChange(MenuType.BUILD, "useMenu", bln)
                    }
                  />
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell className="text-center">
                  <Switch
                    ...
                    onCheckedChange={(bln) =>
                      switchDataChange(MenuType.KNOWLEDGE, "useMenu", bln)
                    }
                  />
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell className="text-center">
                  <Switch
                    ...
                    onCheckedChange={(bln) =>
                      switchDataChange(MenuType.MODEL, "useMenu", bln)
                    }
                  />
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell className="text-center">
                  <Switch
                    ...
                    onCheckedChange={(bln) =>
                      switchDataChange(MenuType.EVALUATION, "useMenu", bln)
                    }
                  />
                </TableCell>
              </TableRow>
              ...
              <TableBody>
                {data.map((el) => (
                  <TableRow key={el.id}>
                    ...
                    <TableCell className="text-center">
                      <Switch
                        checked={form.useFlows.includes(el.id)}
                        onCheckedChange={(bln) =>
                          switchDataChange(el.id, "useFlows", bln)
                        }
                      />
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow key={el.id}>
                    ...
                    <TableCell className="text-center">
                      <Switch
                        ...
                        onCheckedChange={(bln) =>
                          switchDataChange(el.id, "useTools", bln)
                        }
                      />
                    </TableCell>
                  </TableRow>
