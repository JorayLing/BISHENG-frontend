      ...
      <div className="relative flex-1 flex flex-col gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button
            ...
            variant="secondary"
            onClick={() =>
              handleRegexClick("。", "after", "中文句号后切分，中文断句")
            }
          >
            。✂️
          </Button>
          <Button
            ...
            variant="secondary"
            onClick={() =>
              handleRegexClick("\\.", "after", "英文句号后切分，英文断句")
            }
          >
            \.✂️
          </Button>
        ...
        >
          <RadioGroupItem className="" value="before" />
          {t("before")}
          <RadioGroupItem className="" value="after" />
          {t("after")}
          <span>切分</span>
        </RadioGroup>
