    ...
    <div className="flex-1 flex flex-col relative max-w-[760px] mx-auto">
      ...
      >
            ...
            <div className="w-1/2 flex items-center gap-3">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) =>
                    handleSettingChange("chunkSize", e.target.value)
                  }
            ...
            <div className="w-1/2 flex items-center gap-3">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) =>
                    handleSettingChange("chunkOverlap", e.target.value)
                  }
          ...
          <div className="flex items-center gap-2 pt-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                handleSettingChange("retainImages", checked)
              }
            />
            <Label
              htmlFor="keepImages"
        ...
        <div className=" p-4 border rounded-lg">
          <Label
            htmlFor="splitMethod"
            className="flex justify-start text-md text-left font-bold text-gray-800"
          >
            {t("splitMethod")}
          </Label>
          ...
          <div className="space-y-4 p-4 border rounded-lg">
            ...
            <div className="flex items-center gap-2 pt-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  handleSettingChange("forceOcr", checked)
                }
              />
              ...
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  handleSettingChange("enableFormula", checked)
                }
              />
