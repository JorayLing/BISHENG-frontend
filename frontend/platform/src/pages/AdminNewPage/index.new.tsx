...
export default function AdminNewPage() {
  ...
  const getComponentMap = () => {
    const baseMap: Record<string, React.ComponentType<any>> = {
      ...
      chat: ChatSubRoute,
      users: UsersSubRoute,
      roles: () => <div className="p-6"><h2 className="text-xl font-semibold">角色管理</h2></div>,
      docs: () => <div className="p-6"><h2 className="text-xl font-semibold">项目文档</h2></div>,
      settings: () => <div className="p-6"><h2 className="text-xl font-semibold">系统设置</h2></div>,
    };
        ...
        <nav className="mt-6">
          ...
          <div className="mb-4">
            ...
            >
              ...
              <span className="font-medium">{homeMenuItem.label}</span>
            </button>
          </div>
