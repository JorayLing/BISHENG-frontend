...
export default function NewChatPro({ type = AppNumType.SKILL, flowId: propFlowId }: { type?: AppNumType; flowId?: string }) {
  ...
  return (
    <div className="chatBox">
      <div className="chatBox-left">
        ...
        <div className="chat-title">历史对话</div>
        <div ref={chatsRef} className="chat-list">
          {chatList.length === 0 && <div>暂无聊天记录</div>}
          {chatList
