      ...
      <div className="w-fit group min-h-8 max-w-[90%]">
        ...
        <div className="rounded-2xl px-6 py-4 bg-[#EEF2FF] dark:bg-[#333A48]">
          <div className="flex gap-2 ">
            <div className="text-[#0D1638] dark:text-[#CFD5E8] text-sm break-all whitespace-break-spaces">
              {msg}
            </div>
            ...
            <div className="flex justify-between mt-2">
              ...
              <div className="flex gap-2 text-gray-400 cursor-pointer self-end">
                {"question" === data.category && (
                  <Button
                    className="h-6 text-xs group-hover:opacity-100 opacity-0"
                    onClick={onMarkClick}
                  >
                    <FlagIcon
                      width={12}
              ...
              <div className="flex justify-between mt-2 opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                {!debug && (
                  <div className="flex gap-0.5 text-gray-400 cursor-pointer self-end">
                    {!running && (
                      <SquarePen
                        className="size-6 p-1 hover:text-gray-500"
