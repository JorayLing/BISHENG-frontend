      ...
      <div>
        {stop.show ? (
          <div
            ...
            className={`w-[38px] h-[38px] bg-foreground rounded-full flex justify-center items-center cursor-pointer ${stop.disable && "bg-muted-foreground text-muted-foreground"}`}
          >
          ...
          <div
            id="bs-send-btn"
            className="w-[38px] h-[38px] rounded-sm hover:bg-gray-200 dark:hover:bg-gray-950 cursor-pointer flex justify-center items-center"
            onClick={() => {
              !inputLock.locked && handleSendClick();
            }}
          >
