...
const CreateDataSet = forwardRef(({ onChange }, ref) => {
  ...
  const handleSubmit = () => {
    ...
    const isKnowledgeLibEmpty =
      form.importMethod === "qa" && form.knowledgeLib.length === 0;
    setError({
    ...
    if (form.dataSetName.length > 30)
      errors.push(t("dataset.maxDataSetNameLength"));
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-[625px]">
        ...
        <div className="flex flex-col gap-4 py-2">
          ...
          <div>
            <label htmlFor="importMethod" className="bisheng-label">
              {t("dataset.importMethod")}
            </label>
            <RadioGroup
              defaultValue="local"
          ...
          {form.importMethod === "local" && (
            <div>
              <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      downloadFile(
                        __APP_ENV__.BASE_URL + "/dataset.json",
              ...
              <SimpleUpload
                filekey="file"
                uploadUrl={__APP_ENV__.BASE_URL + "/hjapi/v1/knowledge/upload"}
                accept={["json"]}
          ...
          {form.importMethod === "qa" && (
            <div>
              <label htmlFor="knowledgeLib" className="bisheng-label">
                <span className="text-red-500">*</span>
                {t("dataset.selectQaKnowledgeLib")}
              </label>
              <KnowledgeSelect
                type="qa"
                multiple
        ...
        <DialogFooter>
          ...
          <Button type="submit" className="px-11" onClick={handleSubmit}>
            {t("confirm")}
          </Button>
        </DialogFooter>
      </DialogContent>
