...
export default function Parameter({
  ...
  switch (item.type) {
    ...
    case "number":
      return (
        <InputItem type="number" data={item} onChange={handleOnNewValue} />
      );
    case "char_number":
      return (
        <InputItem char type="number" data={item} onChange={handleOnNewValue} />
      );
    case "code_input":
      return (
        <CodeInputItem
