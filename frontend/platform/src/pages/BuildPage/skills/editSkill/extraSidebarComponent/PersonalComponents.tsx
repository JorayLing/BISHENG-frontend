  ...
  return (
    <TooltipProvider delayDuration={0} skipDelayDuration={200}>
      <Tooltip>
        ...
        <TooltipContent
          className="bg-gray-0 rounded-md "
          side="right"
          collisionPadding={20}
        >
          <div className="">
            <Button
              variant="outline"
              className="w-full bg-gray-50 rounded-full text-gray-500"
              onClick={upFile}
            >
                ...
                <div key={comp.name} data-tooltip-id={comp.name}>
                  ...
                  >
                    <div className="side-bar-components-div-form border-solid rounded-full">
                      <span className="side-bar-components-text max-w-40">
                        {" "}
                        {comp.name}{" "}
                      </span>
                      <Menu className="side-bar-components-icon " />
                      <CircleX
                        className="side-bar-components-icon ml-2 cursor-pointer"
                        onClick={(e) => handleDel(e, comp)}
                      />
                    </div>
                  </div>
                </div>
