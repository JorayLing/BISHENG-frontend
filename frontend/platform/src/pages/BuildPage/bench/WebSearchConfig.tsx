  ...
  const renderParams = () => {
    ...
    switch (config.tool) {
      case "bing":
        return (
          <>
            <Label className="bisheng-label text-sky-900 mt-4 block">
              Bing Subscription Key <span className="text-red-500">*</span>
            </Label>
            <div className="mt-3">
              <Input
                type="password"
              ...
              />
              {errors.params?.api_key && (
                <span className="text-red-500 text-sm">
                  Bing Subscription Key {errors.params.api_key}
                </span>
              )}
            </div>
            <Label className="bisheng-label text-sky-900 mt-4 block">
              Bing Search URL <span className="text-red-500">*</span>
            </Label>
            <div className="mt-3">
              <Input
              ...
              />
              {errors.params?.base_url && (
                <span className="text-red-500 text-sm">
                  Bing Search URL {errors.params.base_url}
                </span>
              )}
            </div>
          </>
        ...
        return (
          <>
            ...
            <div className="mt-3">
              ...
              />
              {errors.params?.engine && (
                <span className="text-red-500 text-sm">
                  Engine {errors.params.engine}
                </span>
              )}
            </div>
          </>
  ...
  return (
    <>
      <div className="mb-6 pr-96">
        ...
        <div className="mt-3">
          <Select value={config.tool} onValueChange={handleToolChange}>
            <SelectTrigger>
