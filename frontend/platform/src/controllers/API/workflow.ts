 ...
 * 上线指定版本工作流
 */
export const onlineWorkflowApi = async (data: {
  flow_id;
  version_id;
  status;
}) => {
  ...
  if (nodeData.type === "report") {
    ...
    if (version_key) {
      return axios
        ...
        .then((res) => {
          nodeData.group_params[0].params[0].value.version_key =
            res.version_key;
...
const workflowTemplate = [
        ...
        params: [
          {
            ...
            type: "textarea",
            placeholder:
              "每次工作流开始执行时向用户发送此消息，支持 Markdown 格式，为空时不发送。",
          },
          {
            key: "guide_question",
            label: "引导问题",
  ...
  },
  {
    ...
    name: "输入",
    description:
      "接收用户在会话页面的输入，支持 2 种形式：对话框输入，表单输入。",
    type: "input",
    v: "2",
    tab: {
      value: "dialog_input",
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            key: "output",
            global:
              "code:value.map(el => ({ label: el.label, value: el.key }))",
            label: "输出变量",
  ...
  },
  {
    ...
    name: "助手",
    description:
      "AI 自主进行任务规划，选择合适的知识库、数据库或工具进行调用。",
    type: "agent",
    v: "2",
    tab: {
      value: "single",
  ...
  },
  {
    ...
    name: "文档知识库问答",
    description:
      "根据用户问题从知识库中检索相关内容，结合检索结果调用大模型生成最终结果，支持多个问题并行执行。",
    type: "rag",
    v: "1",
    group_params: [
      {
...
const workflowTemplateEN = [
        ...
        params: [
          {
            ...
            type: "textarea",
            placeholder:
              "Send this message to the user each time the workflow starts. Supports Markdown format. Leave blank if not needed.",
          },
          {
            key: "guide_question",
  ...
  },
  {
    ...
    name: "Input",
    description:
      "Receive user input on the session page, supports two forms: dialog input, form input.",
    type: "input",
    v: "2",
    tab: {
      value: "dialog_input",
  ...
  },
  {
    ...
    name: "Output",
    description:
      "Send messages to users and support richer interactions, such as requesting user approval for sensitive operations or allowing users to directly modify and submit model-generated content.",
    type: "output",
    v: "2",
    group_params: [
      {
        params: [
          {
            ...
            required: true,
            placeholder:
              "Enter the message to send to the user, e.g., 'I will perform XX operation next, please confirm', or 'Here is my draft, feel free to modify it'.",
            value: {
              msg: "",
              files: [],
            },
  ...
  },
  {
    ...
    name: "LLM",
    description:
      "Invoke a large language model to answer user questions or process tasks.",
    type: "llm",
    v: "2",
    tab: {
      value: "single",
  ...
  },
  {
    ...
    name: "Agent",
    description:
      "AI autonomously plans tasks and selects appropriate knowledge bases or tools for invocation.",
    type: "agent",
    v: "2",
    tab: {
      value: "single",
        ...
        params: [
          {
            ...
            value: "",
            placeholder:
              "Please configure the assistant inference model in Model Management - System Model Settings",
          },
          {
            key: "temperature",
            label: "Temperature",
  ...
  },
  {
    ...
    name: "QA Retrieval",
    description:
      "Retrieve questions and corresponding answers from the QA knowledge base.",
    type: "qa_retriever",
    v: "1",
    group_params: [
      {
  ...
  },
  {
    ...
    description:
      "Retrieve relevant content from the knowledge base based on user questions and generate final answers using the retrieved results and a large language model. Supports parallel execution for multiple questions.",
    type: "rag",
    v: "1",
    group_params: [
      {
