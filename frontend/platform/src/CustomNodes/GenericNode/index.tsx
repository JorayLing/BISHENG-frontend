    ...
    <>
      ...
      <div
        className={classNames(
          "border-4 generic-node-div relative",
          selected ? "border-ring" : "",
        )}
        style={{
          borderColor: nodeColors[types[data.type]] ?? nodeColors.unknown,
        }}
      >
        {isGroup && (
          <div
            className={`generic-node-div absolute border-2 w-full h-full left-3 top-3 z-[-1] ${selected ? "border-ring" : ""}`}
            style={{
              borderColor: nodeColors[types[data.type]] ?? nodeColors.unknown,
            }}
          >
            <div
              className={`generic-node-div absolute border-4 w-full h-full left-3 top-3 z-[-1] bg-transparent ${selected ? "border-ring" : ""}`}
              style={{
                borderColor: nodeColors[types[data.type]] ?? nodeColors.unknown,
              }}
            ></div>
        ...
        <div className="generic-node-desc nodrag">
          ...
          <>
            ...
            />
            {data.type === "Report" && (
              <div className="w-full bg-muted px-5 py-2">
                <Link to={`/report/${flowId}`}>
                  <Button
                    variant="outline"
                    className="px-10"
                    onClick={() => {
