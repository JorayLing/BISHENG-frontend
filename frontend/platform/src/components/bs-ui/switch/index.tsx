...
>(({ className, texts = null, ...props }, ref) => (
  ...
  >
    ...
    {texts && (
      <>
        <span className="text text-xs absolute left-1 text-gray-50 hidden group-data-[state=checked]:block">
          {texts[0]}
        </span>
        <span className="text text-xs absolute right-1 text-gray-400 hidden group-data-[state=unchecked]:block">
          {texts[1]}
        </span>
      </>
    )}
