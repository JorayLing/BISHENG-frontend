...
function ConfirmWrapper() {
  ...
  const handleOkClick = () => {
    paramRef.current?.onOk ? paramRef.current?.onOk?.(close) : close();
  };
        ...
        <div className="alert-dialog">
          ...
          <div className="alert-dialog-content">
            ...
            <div className="alert-dialog-footer">
              <div onClick={handleCancelClick} className="alert-dialog-cancel">
                {canelTxt}
              </div>
              <div onClick={handleOkClick} className="alert-dialog-ok">
                {okTxt}
              </div>
            </div>
          </div>
