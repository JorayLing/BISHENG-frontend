  ...
  return (
    <div className="pl-6 mb-4">
      <div className="relative flex justify-between mb-2">
        ...
        {required ? (
          <span className="text-red-500 min-w-12">{t("api.required")}</span>
        ) : (
          <span className="text-gray-500 min-w-12">{t("api.optional")}</span>
        )}
        {line && (
          <div className="absolute bg-input w-6 h-[1px] -left-8 top-2.5"></div>
        )}
      </div>
      {example && (
        <div className="mb-2">
      ...
      {children && (
        <div className="border-l border-dashed border-input pl-2">
          {children}
        </div>
      )}
    </div>
    ...
    <section className="max-w-[1600px] flex-grow">
      <Card className="mb-8">
        ...
        <CardContent>
          ...
          <p className="mt-2">{t("api.sdkNote")}</p>
