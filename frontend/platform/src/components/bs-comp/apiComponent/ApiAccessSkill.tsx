              ...
              <TableRow>
                <TableCell className="align-top">
                  <JsonItem
                    ...
                    type="UUID"
                    desc={t("api.skillId")}
                    remark={t("api.urlParam")}
                  ></JsonItem>
                  <JsonItem
                    name="inputs"
                    required
                    type="Json"
                    desc={t("api.skillInput")}
                    example='{"query":"什么是金融"}'
                    remark={t("api.singleInput")}
                  ></JsonItem>
                  <JsonItem
                    name="history_count"
                    type="int"
                    desc={t("api.historyCount")}
                  ></JsonItem>
                  <JsonItem
                    name="clear_cache"
                    type="boolean"
                    desc={t("api.clearCache")}
                  ></JsonItem>
                  <JsonItem
                    name="session_id"
                    type="str"
                    desc={t("api.sessionId")}
                    remark={t("api.sessionRemark")}
                  ></JsonItem>
                  <JsonItem
                    name="tweaks"
                    required
                    type="Json"
                    desc={t("api.tweaks")}
                    remark={t("api.tweaksRemark")}
                  >
                    <JsonItem
                      line
                      name="ChatOpenAI-MzIaC"
                      type="Json"
                      desc={t("api.exampleComponent")}
                      example='{"openai_api_key": "sk-xxx"} 或者 {}'
                      remark={t("api.defaultConfig")}
                    ></JsonItem>
                    <JsonItem
                      line
                      name="..."
                      type="Json"
                      desc={t("api.componentParams")}
                    ></JsonItem>
                  </JsonItem>
                </TableCell>
                <TableCell className="align-top">
              ...
              <TableRow>
                <TableCell className="align-top">
                  <JsonItem
                    name="data"
                    type="object"
                    desc={t("api.returnContent")}
                  >
                    <JsonItem
                      line
                      name="session_id"
                      type="string"
                      desc={t("api.sessionIdReturn")}
                    ></JsonItem>
                    <JsonItem
                      line
                      name="result"
                      type="object"
                      desc={t("api.skillResult")}
                    >
                      <JsonItem
                        line
                        name="answer"
                        type="string"
                        desc={t("api.llmAnswer")}
                      ></JsonItem>
                      <JsonItem
                        line
                        name="message_id"
                        type="int"
                        desc={t("api.messageId")}
                      ></JsonItem>
                      <JsonItem
                        line
                        name="source"
...
print(run_flow(inputs, flow_id=FLOW_ID, tweaks=TWEAKS))`}
  ...
  "ProxyChatLLM-NloT5": {}
          ...
          <h3 className="text-lg font-medium mb-2 mt-12">
            {t("api.reportGenerationDemo")}
          </h3>
