          ...
          <div className="flex h-9 my-[14px]">
            <Link className="inline-block" to="/">
              ...
              <img
                ...
                className="w-[104px] ml-[38px] rounded dark:w-[104px]"
                alt=""
              />
            </Link>
          </div>
          ...
          <div className="flex w-fit relative z-10">
            <div className="flex">
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger
                    className="h-8 w-8 bg-header-icon rounded-lg cursor-pointer my-4"
                  ...
                  <TooltipContent>
                    <p>{t("menu.themeSwitch")}</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
              <Separator
                className="mx-[4px] dark:bg-[#111111]"
              ...
              <Separator
                className="mx-[23px] h-6 border-l my-5 border-[#dddddd]"
                orientation="vertical"
              />
            </div>
            <div className="flex items-center h-7 my-4">
              {/* @ts-ignore */}
              <img
                className="h-7 w-7 rounded-2xl mr-4"
              ...
              <SelectHover
                triagger={
                  <span className="leading-8 text-[14px] mr-8 max-w-40 cursor-pointer text-ellipsis overflow-hidden whitespace-nowrap">
                    {user.user_name}{" "}
                    <ChevronDown className="inline-block mt-[-2px]" />
                  </span>
                }
              >
                <SelectHoverItem onClick={JumpResetPage}>
                  <Lock className="w-4 h-4 mr-1" />
                  <span>{t("menu.changePwd")}</span>
                </SelectHoverItem>
                <SelectHoverItem onClick={handleLogout}>
                  <QuitIcon className="w-4 h-4 mr-1" />
            ...
            <nav className="">
              ...
              {isMenu("build") && (
                <NavLink
                  ...
                  className={`navlink inline-flex rounded-lg w-full px-6 hover:bg-nav-hover h-12 mb-[3.5px]`}
                >
                  <TechnologyIcon className="h-6 w-6 my-[12px]" />
                  <span className="mx-[14px] max-w-[48px] text-[14px] leading-[48px]">
                    {t("menu.skills")}
                  </span>
                </NavLink>
              ...
              {isMenu("knowledge") && (
                <NavLink
                  ...
                  className={`navlink inline-flex rounded-lg w-full px-6 hover:bg-nav-hover h-12 mb-[3.5px]`}
                >
                  <KnowledgeIcon className="h-6 w-6 my-[12px]" />
                  <span className="mx-[14px] max-w-[48px] text-[14px] leading-[48px]">
                    {t("menu.knowledge")}
                  </span>
                </NavLink>
              ...
              {user.role === "admin" && (
                <>
                  <NavLink
                    ...
                    className={`navlink inline-flex rounded-lg w-full px-6 hover:bg-nav-hover h-12 mb-[3.5px]`}
                  >
                    <DatasetIcon className="h-6 w-6 my-[12px]" />
                    <span className="mx-[14px] max-w-[48px] text-[14px] leading-[48px]">
                      {t("menu.dataset")}
                    </span>
                  </NavLink>
              ...
              {isMenu("model") && (
                <NavLink
                  ...
                  className={`navlink inline-flex rounded-lg w-full px-6 hover:bg-nav-hover h-12 mb-[3.5px]`}
                >
                  <ModelIcon className="h-6 w-6 my-[12px]" />
                  <span className="mx-[14px] max-w-[48px] text-[14px] leading-[48px]">
                    {t("menu.models")}
                  </span>
                </NavLink>
              ...
              {isMenu("evaluation") && (
                <NavLink
                  ...
                  className={`navlink inline-flex rounded-lg w-full px-6 hover:bg-nav-hover h-12 mb-[3.5px]`}
                >
                  <EvaluatingIcon className="h-6 w-6 my-[12px]" />
                  <span className="mx-[14px] max-w-[48px] text-[14px] leading-[48px]">
                    {t("menu.evaluation")}
                  </span>
                </NavLink>
              )}
              {
                <NavLink
                  ...
                  className={`navlink inline-flex rounded-lg w-full px-6 hover:bg-nav-hover h-12 mb-[3.5px]`}
                >
                  <LabelIcon className="h-6 w-6 my-[12px]" />
                  <span className="mx-[14px] max-w-[48px] text-[14px] leading-[48px]">
                    {t("menu.annotation")}
                  </span>
                </NavLink>
              ...
              {isAdmin && (
                <>
                  <NavLink
                    ...
                    className={`navlink inline-flex rounded-lg w-full px-6 hover:bg-nav-hover h-12 mb-[3.5px]`}
                  >
                    <LogIcon className="h-6 w-6 my-[12px]" />
                    <span className="mx-[14px] max-w-[48px] text-[14px] leading-[48px]">
                      {t("menu.log")}
                    </span>
                  </NavLink>
              ...
              {isAdmin && (
                <>
                  <NavLink
                    ...
                    className={`navlink inline-flex rounded-lg w-full px-6 hover:bg-nav-hover h-12 mb-[3.5px]`}
                  >
                    <SystemIcon className="h-6 w-6 my-[12px]" />
                    <span className="mx-[14px] max-w-[48px] text-[14px] leading-[48px]">
                      {t("menu.system")}
                    </span>
                  </NavLink>
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger className="h-[72px] w-[78px] cursor-pointer bg-background-tip rounded-lg hover:bg-[#1b1f23] hover:text-[white] transition-all dark:hover:bg-background-tip-darkhover">
                        <Link
                          to={"https://github.com/dataelement/bisheng"}
                          target="_blank"
                        >
                          <GithubIcon className="side-bar-button-size mx-auto w-5 h-5 " />
                          <span className="block text-[12px] mt-[8px] font-bold">
                            {t("menu.github")}
                          </span>
                        </Link>
                      </TooltipTrigger>
          ...
          {!appConfig.isPro && (
            <div className="flex mt-8 justify-center gap-4">
              <a
                ...
                target="_blank"
              >
                <GithubIcon className="side-bar-button-size mx-auto" />
                Github
              </a>
              <a
                href={
                ...
                target="_blank"
              >
                <BookOpenIcon className="side-bar-button-size mx-auto" />{" "}
                {t("menu.onlineDocumentation")}
              </a>
            </div>
          )}
        </div>
