    ...
    var e = {
        ...
        386: (e, t, n) => {
          ...
          var r = n(793),
            ...
            o = function (e, t) {
              ...
              var n = i.abcRenderAdapter.getElements(e);
              n.length > 0 &&
                (0, a.G)(
                  ...
                  n.forEach(function (e) {
                    e.parentElement.classList.contains("vditor-wysiwyg__pre") ||
                      ...
                      ("true" !== e.getAttribute("data-processed") &&
                        (ABCJS.renderAbc(
                          e,
                          i.abcRenderAdapter.getCode(e).trim(),
                        ),
        ...
        781: (e, t, n) => {
          (n.r(t),
            n.d(t, {
              ...
              graphvizRenderAdapter: () => l,
              markmapRenderAdapter: () => i,
              mathRenderAdapter: () => r,
              mermaidRenderAdapter: () => a,
              mindmapRenderAdapter: () => o,
        ...
        379: (e, t, n) => {
          ...
          var r = n(793),
            ...
            o = function (e, t, n) {
              (void 0 === e && (e = document), void 0 === t && (t = r.g.CDN));
              var o = i.chartRenderAdapter.getElements(e);
              o.length > 0 &&
                (0, a.G)(
                  ...
                  o.forEach(function (e) {
                    if (
                      ...
                      var t = i.chartRenderAdapter.getCode(e).trim();
                      if (t)
                        try {
                ...
                .forEach(function (e) {
                  ...
                  ((d.className = "vditor-copy"),
                    (d.innerHTML = '<span aria-label="'
                      ...
                      .concat(
                        (null === (i = window.VditorI18n) || void 0 === i
                          ? void 0
                          : i.copy) || "复制",
        ...
        169: (e, t, n) => {
          ...
          var r = n(793),
            ...
            o = function (e, t) {
              void 0 === t && (t = r.g.CDN);
              var n = i.flowchartRenderAdapter.getElements(e);
              0 !== n.length &&
                (0, a.G)(
                  ...
                  n.forEach(function (e) {
                    if ("true" !== e.getAttribute("data-processed")) {
                      var t = flowchart.parse(
                        i.flowchartRenderAdapter.getCode(e),
                      );
                      ((e.innerHTML = ""),
                        t.drawSVG(e),
                        e.setAttribute("data-processed", "true"));
        ...
        572: (e, t, n) => {
          ...
          var r = n(793),
            ...
            o = function (e, t) {
              void 0 === t && (t = r.g.CDN);
              var n = i.graphvizRenderAdapter.getElements(e);
              0 !== n.length &&
                (0, a.G)(
                  ...
                  n.forEach(function (e) {
                    var t = i.graphvizRenderAdapter.getCode(e);
                    if (
                      !e.parentElement.classList.contains(
                        "vditor-wysiwyg__pre",
                      ) &&
        ...
        702: (e, t, n) => {
          ...
          var r = n(793),
            ...
            o = function (e, t, n) {
              ...
              var o = e.style;
              r.g.CODE_THEME.includes(o) || (o = "github");
              var c = document.getElementById("vditorHljsStyle"),
                s = ""
                  .concat(n, "/dist/js/highlight.js/styles/")
                  .concat(o, ".css");
              (c && c.getAttribute("href") !== s && c.remove(),
              (0, i.c)(
                "".concat(n, "/dist/js/highlight.js/styles/").concat(o, ".css"),
                "vditorHljsStyle",
              ),
              !1 !== e.enable) &&
                      ...
                      t.querySelectorAll("pre > code").forEach(function (t) {
                        if (
                          ...
                          var r = getComputedStyle(t).whiteSpace,
                            a = !1;
                          ("pre-wrap" !== r && "pre-line" !== r) || (a = !0);
                          var i = "",
                            o = t.textContent.split(/\r\n|\r|\n/g);
                          (o.pop(),
                            o.map(function (e) {
                              var t = "";
                              (a &&
              ...
              var s = e.firstChild,
                ...
                d = (function (e, t) {
                  ...
                  var a = e.getAssets(r),
                    ...
                    c = a.scripts,
                    s = window.markmap;
                  return (i && s.loadCSS(i), c && s.loadJS(c), n);
                })(c, t),
                u = d.root,
                m = d.frontmatter,
                p = i(null == m ? void 0 : m.markmap);
              (l.setData(u, p), l.fit());
            },
            s = function (e, t, n) {
              void 0 === t && (t = r.g.CDN);
              var o = i.markmapRenderAdapter.getElements(e);
              0 !== o.length &&
                (0, a.G)(
                  ...
                  o.forEach(function (e) {
                    var t = i.markmapRenderAdapter.getCode(e);
                    if (
                      "true" !== e.getAttribute("data-processed") &&
                      "" !== t.trim()
                    ) {
        ...
        982: (e, t, n) => {
          ...
          var r = n(793),
            ...
            c = n(781),
            s = function (e, t) {
              var n = c.mathRenderAdapter.getElements(e);
              if (0 !== n.length) {
                var s = {
                  cdn: r.g.CDN,
                ...
                if (
                      ...
                      (0, a.G)(
                        ...
                        n.forEach(function (e) {
                          if (
                            ...
                            var n = (0, o.X)(c.mathRenderAdapter.getCode(e));
                  ...
                  var l = function (e, t) {
                    var n = (0, o.X)(e.textContent).trim(),
                    ...
                    ((r.display = "DIV" === e.tagName),
                      window.MathJax.tex2svgPromise(n, r).then(function (r) {
                        ...
                        var a = r.querySelector('[data-mml-node="merror"]');
                        (a &&
                          "" !== a.textContent.trim() &&
                          ((e.innerHTML = a.textContent.trim()),
                          (e.className = "vditor-reset--error")),
                          t && t());
                      }));
                  };
                      ...
                      var e = [],
                        t = function (t) {
                          ...
                          r.parentElement.classList.contains(
                            ...
                            !(0, o.X)(r.textContent).trim() ||
                            e.push(function (e) {
                              t === n.length - 1 ? l(r) : l(r, e);
                            });
                        },
                        r = 0;
                      r < n.length;
                      ...
                      : t.match(/^.+.(mp3|wav|flac)$/)
                        ...
                        : (function (e, t) {
                            ...
                            if (n && 11 === n[1].length)
                              ...
                              (t.indexOf("bvid=") > -1 || (l && l[1]))
                            ) {
                              var u = {
                                bvid: (0, r.o)("bvid", t) || (l && l[1]),
                                page: "1",
                                high_quality: "1",
                                as_wide: "1",
        ...
        570: (e, t, n) => {
          ...
          var r = n(793),
            ...
            l = function (e, t, n) {
              void 0 === t && (t = r.g.CDN);
              var l = i.mermaidRenderAdapter.getElements(e);
              0 !== l.length &&
                (0, a.G)(
                      ...
                      return c(void 0, void 0, void 0, function () {
                        ...
                        return s(this, function (s) {
                          switch (s.label) {
                            case 0:
                              if (
                                ((t = i.mermaidRenderAdapter.getCode(e)),
                                "true" === e.getAttribute("data-processed") ||
                                  "" === t.trim())
                              )
                                return [2];
                              ((n = "mermaid" + (0, o.W)()), (s.label = 1));
                            case 1:
                              return (
                                s.trys.push([1, 3, , 4]),
        ...
        558: (e, t, n) => {
          ...
          var r = n(793),
            ...
            o = function (e, t, n) {
              (void 0 === e && (e = document), void 0 === t && (t = r.g.CDN));
              var o = i.mindmapRenderAdapter.getElements(e);
              o.length > 0 &&
                (0, a.G)(
                  "".concat(t, "/dist/js/echarts/echarts.min.js"),
                  "vditorEchartsScript",
                  ...
                  o.forEach(function (e) {
                    if (
                      ...
                      var t = i.mindmapRenderAdapter.getCode(e);
                      if (t)
                        try {
                          if ("true" === e.getAttribute("data-processed"))
                            return;
            ...
            i = function (e, t, n) {
              ...
              if (
                (Array.from(e.children).forEach(function (e, t) {
                  if ((0, r.W)(e)) {
                    if (n) {
                      var a = e.id.lastIndexOf("_");
                      e.id = e.id.substring(0, -1 === a ? void 0 : a) + "_" + t;
                    }
                    (o.push(e.id), (i += e.outerHTML.replace("<wbr>", "")));
                  }
                }),
                "" === i)
              )
                ...
                (n.lute.SetToC(!0),
                  "wysiwyg" !== n.currentMode || n.preview.element.contains(e)
                    ? "ir" !== n.currentMode || n.preview.element.contains(e)
                      ? (c.innerHTML = n.lute.HTML2VditorDOM(
                          "<p>[ToC]</p>" + i,
                        ))
                      : (c.innerHTML = n.lute.SpinVditorIRDOM(
                          "<p>[ToC]</p>" + i,
                        ))
                    : (c.innerHTML = n.lute.SpinVditorDOM("<p>[ToC]</p>" + i)),
                  n.lute.SetToC(n.options.preview.markdown.toc));
              else {
                t.classList.add("vditor-outline");
                var s = Lute.New();
                (s.SetToC(!0),
                  (c.innerHTML = s.HTML2VditorDOM("<p>[ToC]</p>" + i)));
              }
              var l = c.firstElementChild.querySelectorAll(
              ...
              return (
                l.forEach(function (e, t) {
                  ...
                  e.setAttribute("data-target-id", o[t]);
                }),
                (i = c.firstElementChild.innerHTML),
                0 === l.length
                  ? ((t.innerHTML = ""), i)
                  : ((t.innerHTML = i),
                    n &&
                    ...
                    t.firstElementChild.addEventListener("click", function (r) {
                      for (var a = r.target; a && !a.isEqualNode(t); ) {
                        if (a.classList.contains("vditor-outline__action")) {
                          (a.classList.contains("vditor-outline__action--close")
                            ? (a.classList.remove(
                                "vditor-outline__action--close",
                              ),
                              a.parentElement.nextElementSibling.setAttribute(
                                "style",
                                "display:block",
                              ))
                            : (a.classList.add("vditor-outline__action--close"),
                              a.parentElement.nextElementSibling.setAttribute(
                                "style",
                                "display:none",
                              )),
                        ...
                        if (a.getAttribute("data-target-id")) {
                          ...
                          if (n)
                            if ("auto" === n.options.height) {
                              var o = i.offsetTop + n.element.offsetTop;
                              (n.options.toolbarConfig.pin ||
                                (o += n.toolbar.element.offsetHeight),
                                window.scrollTo(window.scrollX, o));
                            } else
                              (n.element.offsetTop < window.scrollY &&
                                ...
                                n.preview.element.contains(e)
                                  ? (e.parentElement.scrollTop = i.offsetTop)
                                  : (e.scrollTop = i.offsetTop));
                          else window.scrollTo(window.scrollX, i.offsetTop);
                          break;
                        }
                        a = a.parentElement;
                      }
        ...
        931: (e, t, n) => {
          ...
          var r = n(793),
            ...
            o = function (e, t) {
              (void 0 === e && (e = document), void 0 === t && (t = r.g.CDN));
              var n = i.plantumlRenderAdapter.getElements(e);
              0 !== n.length &&
                (0, a.G)(
                  ...
                  n.forEach(function (e) {
                    if (
                      ...
                      var t = i.plantumlRenderAdapter.getCode(e).trim();
                      if (t)
                        try {
                          e.innerHTML =
        ...
        971: (e, t, n) => {
          ...
          var r = function (e, t, n) {
            ...
            var a = document.querySelector(".vditor-img img"),
              i = "translate3d("
                .concat(
            ...
            setTimeout(function () {
              (a.setAttribute(
                "style",
                "transition: transform .3s ease-in-out;transform: ".concat(i),
              ),
                setTimeout(function () {
                  a.parentElement.scrollTo(
                    (a.parentElement.scrollWidth -
                      a.parentElement.clientWidth) /
                      2,
                    (a.parentElement.scrollHeight -
                      a.parentElement.clientHeight) /
                      2,
                  );
                }, 400));
            });
            var o = document.querySelector(".vditor-img__btn");
            o.addEventListener("click", function () {
              var t = parseInt(o.getAttribute("data-deg"), 10) + 90;
              ((t / 90) % 2 == 1 &&
              e.naturalWidth > a.parentElement.clientHeight
                ...
                : (a.style.transform = ""
                    .concat(i, " rotateZ(")
                    .concat(t, "deg)")),
                o.setAttribute("data-deg", t.toString()),
                setTimeout(function () {
                  a.parentElement.scrollTo(
                    (a.parentElement.scrollWidth -
                      a.parentElement.clientWidth) /
            ...
            i = function (e, t) {
              ...
              n
                ? n.getAttribute("href") !== i &&
                  (n.remove(), (0, a.c)(i, "vditorHljsStyle"))
                : (0, a.c)(i, "vditorHljsStyle");
            };
        },
        652: (e, t, n) => {
          n.d(t, { Z: () => a });
            ...
            a = function (e, t) {
              if (e && t) {
                var n = document.getElementById("vditorContentTheme"),
                  a = "".concat(t, "/").concat(e, ".css");
                n
                  ? n.getAttribute("href") !== a &&
                    (n.remove(), (0, r.c)(a, "vditorContentTheme"))
                  : (0, r.c)(a, "vditorContentTheme");
              }
            };
        },
        998: (e, t, n) => {
      ...
      (() => {
          ...
          T = function (e, t) {
            if (
              ...
              var n = function () {
                ...
                a = '<svg><use xlink:href="#vditor-icon-pause"></use></svg>';
              document.getElementById("vditorIconScript") ||
                ((r =
                ...
                (c.onend = c.onerror =
                  function () {
                    ((i.style.display = "none"),
                      ...
                      i.classList.remove("vditor-speech--current"),
                      (i.innerHTML = r));
                  }),
                e.addEventListener(
                  ...
                  function (t) {
                    ...
                    if (
                      ...
                      return (
                        i.classList.contains("vditor-speech--current")
                          ? speechSynthesis.speaking &&
                            (speechSynthesis.paused
                              ? (speechSynthesis.resume(), (i.innerHTML = a))
                              : (speechSynthesis.pause(), (i.innerHTML = r)))
                          : ((c.text = i.getAttribute("data-text")),
                            speechSynthesis.speak(c),
                            i.classList.add("vditor-speech--current"),
                            (i.innerHTML = a)),
                    ...
                    if (
                      ...
                      var o = getSelection().getRangeAt(0),
                        s = o.toString().trim();
                      if (s) {
                        window.vditorSpeechRange = o.cloneRange();
          ...
          x = function (e) {
            var t,
              n = {
                ...
                cdn: f.g.CDN,
                customEmoji: {},
                emojiPath: "".concat(f.g.CDN, "/dist/images/emoji"),
                hljs: f.g.HLJS_OPTIONS,
                icon: "ant",
                lang: "zh_CN",
                markdown: f.g.MARKDOWN_OPTIONS,
                math: f.g.MATH_OPTIONS,
                mode: "light",
                speech: { enable: !1 },
                render: { media: { enable: !0 } },
                theme: f.g.THEME_OPTIONS,
              };
            return (
              e.cdn &&
                ((null === (t = e.theme) || void 0 === t ? void 0 : t.path) ||
                  (n.theme.path = "".concat(e.cdn, "/dist/css/content-theme")),
                e.emojiPath ||
          ...
          _ = function (t, n, r) {
            return k(void 0, void 0, void 0, function () {
              ...
              return A(this, function (L) {
                switch (L.label) {
                  case 0:
                    return ((v = x(r)), [4, j(n, v)]);
                  case 1:
                    if (
                      ((f = L.sent()),
                      v.transform && (f = v.transform(f)),
                      (t.innerHTML = f),
                      t.classList.add("vditor-reset"),
                      v.i18n)
                    )
                      return [3, 5];
                    if (
                  ...
                  case 2:
                    return (
                      (E = (S = "vditorI18nScript") + v.lang),
                      document
                        .querySelectorAll('head script[id^="'.concat(S, '"]'))
                        .forEach(function (e) {
                          e.id !== E && document.head.removeChild(e);
                        }),
                      [
                        4,
                        (0, y.G)(
                          ""
                            .concat(v.cdn, "/dist/js/i18n/")
                            .concat(v.lang, ".js"),
                          E,
                        ),
                      ]
                  ...
                  case 4:
                    return [3, 6];
                  case 5:
                    ((window.VditorI18n = v.i18n), (L.label = 6));
                  case 6:
                    return v.icon
                      ? [
                          4,
                  ...
                  case 8:
                    return (
                      (0, w.Z)(v.theme.current, v.theme.path),
                      1 === v.anchor && t.classList.add("vditor-reset--anchor"),
                      (0, i.O)(t, v.hljs),
                      (0, s.s)(v.hljs, t, v.cdn),
                      (0, d.H)(t, { cdn: v.cdn, math: v.math }),
                      (0, m.i)(t, v.cdn, v.mode),
                      (0, p.K)(t, v.cdn, v.mode),
                      (0, o.P)(t, v.cdn),
                      (0, c.v)(t, v.cdn),
                      (0, a.p)(t, v.cdn, v.mode),
                      (0, h.P)(t, v.cdn, v.mode),
                      (0, g.B)(t, v.cdn),
                      (0, e.Q)(t, v.cdn),
                      v.render.media.enable && (0, u.Y)(t),
                      v.speech.enable && T(t),
                      0 !== v.anchor &&
                        ((k = v.anchor),
                        document
                          ...
                          .forEach(function (e) {
                            (1 === k && e.classList.add("vditor-anchor--left"),
                              (e.onclick = function () {
        ...
        const C = (function () {
          ...
          return (
            ...
            (n.previewImage = M.E),
            (n.codeRender = i.O),
            (n.graphvizRender = c.v),
            (n.highlightRender = s.s),
            (n.mathRender = d.H),
            (n.mermaidRender = m.i),
            (n.markmapRender = p.K),
            (n.flowchartRender = o.P),
            (n.chartRender = a.p),
            (n.abcRender = e.Q),
            (n.mindmapRender = h.P),
            (n.plantumlRender = g.B),
            (n.outlineRender = v.k),
            (n.mediaRender = u.Y),
            (n.speechRender = T),
            (n.lazyLoadImageRender = l),
            (n.md2html = j),
            (n.preview = _),
            (n.setCodeTheme = H.Y),
            (n.setContentTheme = w.Z),
            n
          );
        })();
      })(),
