      ...
      const n = "[A-Za-z](_?[A-Za-z0-9.])*",
        ...
        r = {
          ...
          contains: [
            ...
            { className: "type", begin: n, endsParent: !0, relevance: 0 },
          ],
        };
      return {
        name: "Ada",
        ...
        q = [
          {
            ...
            starts: {
              contains: [
                { begin: /\(/, end: /\)/, keywords: E, contains: [...S, I, K] },
              ],
            },
          },
...
hljs.registerLanguage(
  ...
  (() => {
    ...
    return (e) => {
      ...
      return (
        (f.contains = [e.COMMENT("comment", ""), b, y, h]),
        (h.contains = g),
        (l.contains = g),
        (p.contains = [l]),
        {
