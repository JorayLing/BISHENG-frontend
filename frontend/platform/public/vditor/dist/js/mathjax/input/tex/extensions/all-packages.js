!(function (t) {
  ...
  function (t, e, r) {
    ...
    ((e.AmsMethods = {}),
      ...
      (e.AmsMethods.HandleDeclareOp = function (t, r) {
        ...
        (i.match(/\\text/) ||
          ...
          t.configuration.handlers
            ...
            .add(
              o,
              new c.Macro(o, e.AmsMethods.Macro, [
                "\\mathop{\\rm " + i + "}" + n,
              ]),
            ));
      }),
      ...
      (e.AmsMethods.xArrow = function (t, e, r, o, s) {
        var c = {
            width: "+" + a.default.Em((o + s) / 18),
            lspace: a.default.Em(o / 18),
          },
          l = t.GetBrackets(e),
          d = t.ParseArg(e),
          p = t.create(
        ...
        if (
          (n.default.setAttribute(m, "voffset", ".15em"),
          n.default.setChild(f, f.over, m),
          l)
        ) {
      ...
      (e.AmsMethods.CFrac = function (t, e) {
        ...
        (r && n.default.setProperties(f, { numalign: r, denomalign: r }),
          t.Push(f));
      }),
    ...
    ((e.RequireLoad = g),
      ...
      (e.RequireConfiguration = i.Configuration.create("require", {
        ...
        config: function (t, e) {
          ...
          (d.CONFIG.paths[a] ||
            (d.CONFIG.paths[a] = "[mathjax]/input/tex/extensions"),
            (r.prefix = "[" + a + "]/"));
        },
        options: e.options,
      })));
      ...
      M = function (t, r, a, n) {
        ...
        i.default.isType(l, "mspace")
          ? i.default.setAttribute(
              ...
              "width",
              s.default.Em(
                s.default.dimen2em(i.default.getAttribute(l, "width")) + a,
              ),
            )
          : ((l = t.nodeFactory.create("node", "mspace", [], {
      ...
      !(function (t) {
        ...
        if (r)
          for (var a = r.length - 1, n = void 0; (n = r[a]); a--)
            if (e.getProperty(n, "sequentProcessed"))
              e.removeProperty(n, "sequentProcessed");
            else {
              var o = [],
                i = x(n);
              if (1 === e.getProperty(i, "inference")) {
                for (o.push(n); 1 === e.getProperty(i, "inference"); ) {
                  ...
                  (e.getProperty(c, "sequent") &&
                    ((n = c.childNodes[0]),
                    o.push(n),
                    e.setProperty(n, "sequentProcessed", !0)),
                    (i = s));
                }
                C(t, o);
              }
      ...
      ((t.disassembleSymbol = function (t, e) {
        ...
        (t.GetParameter = function (t, r, a) {
          ...
          for (var n = t.i, i = 0, s = 0; t.i < t.string.length; ) {
            ...
            if ("{" === c)
              (t.i === n && (s = 1), t.GetArgument(r), (i = t.i - n));
            else {
  ...
  function (t, e, r) {
    ...
    e.AutoloadConfiguration = o.Configuration.create("autoload", {
      ...
      init: function (t) {
        t.options.require ||
          u.defaultOptions(t.options, c.RequireConfiguration.options);
      },
      priority: 10,
    });
  },
    ...
    var a = r(2),
      ...
      c = {
        ...
        MacroWithTemplate: function (t, e, r, n) {
          for (var o = [], c = 4; c < arguments.length; c++)
            o[c - 4] = arguments[c];
          var l = parseInt(n, 10);
          if (l) {
            var u = [];
        ...
        BeginEnv: function (t, e, r, a, n, o) {
          ...
          if (n) {
            ...
            ((r = i.default.substituteArgs(t, c, r)),
              (a = i.default.substituteArgs(t, [], a)));
          }
          return (
            (t.string = i.default.addArgs(t, r, t.string.slice(t.i))),
            (t.i = 0),
        ...
        return (
          ...
          (e.prototype.EndTable = function () {
            if ((t.prototype.EndTable.call(this), this.table.length)) {
              ...
              if (a) {
                r =
                  this.arraydef.side === l.TexConstant.Align.LEFT
                    ? 0
                    : this.table.length - 1;
                var n = this.table[r],
                  o = this.create(
                    "node",
                    "mlabeledtr",
                    [a].concat(s.default.getChildren(n)),
                  );
  ...
  function (t, e, r) {
    ...
    function u(t, e, r, a) {
      ...
      return (
        "mtext" !== e &&
          ...
          (o.default.setProperty(n, "fixBold", !0),
    ...
    function d(t) {
      ...
      try {
        for (
          var n = a(t.data.getList("fixBold")), s = n.next();
          !s.done;
          s = n.next()
        ) {
          var c = s.value;
    ...
    ((l[i.TexConstant.Variant.NORMAL] = i.TexConstant.Variant.BOLD),
      ...
      (l[i.TexConstant.Variant.SANSSERIF] =
  ...
  function (t, e, r) {
    ...
    function d(t, e, r, a, n, o, i) {
      ...
      return (
        (m = t.create("node", "mrow", u)),
        c.setProperty(m, "labelledRule", d),
        m
      );
    }
    function p(t, e) {
    ...
    ((e.CancelMethods = {}),
      ...
      (e.CancelMethods.CancelTo = function (t, e) {
        ...
        ((c.notation = [
          ...
          t.Push(
            t.create("node", "msup", [t.create("node", "menclose", [o], c), a]),
          ));
      }),
      new o.CommandMap(
        "cancel",
      ...
      (e.ColorMethods.FColorBox = function (t, e) {
        var r = t.GetArgument(e),
          ...
          u = t.create("node", "mpadded", s, {
            ...
            style:
              "border: " + c.borderWidth + " solid " + l.getColor("named", r),
          });
  ...
  function (t, e, r) {
    ...
    var a = r(4),
      ...
      o = function (t, e) {
        ...
        return (
          a.default.copyChildren(r, o),
          a.default.copyAttributes(r, o),
          o
        );
      };
    e.default = n;
            ...
            return (
              c
                ...
                : ((n = a.patterns.match_("digits", t.d || "")),
                  r && n && "" === n.remainder
                    ? (a.concatArray(l, a.actions["d="](t, e)),
                      a.concatArray(l, this.output(t)))
                    : (a.concatArray(l, this.output(t)),
    ...
    var n = {
      ...
      _go2: function (t) {
        ...
        switch (t.type_) {
          ...
          case "pu-frac":
            var o =
              "\\frac{" + n._goInner(t.p1) + "}{" + n._goInner(t.p2) + "}";
            e =
              "\\mathchoice{\\textstyle" +
              o +
              "}{" +
          ...
          case "underset":
            e =
              "\\underset{" + n._goInner(t.p1) + "}{" + n._goInner(t.p2) + "}";
            break;
          case "underbrace":
            e =
              "\\underbrace{" +
    ...
    e.NoUndefinedConfiguration = n.Configuration.create("noundefined", {
      fallback: {
        macro: function (t, e) {
          ...
          try {
            for (
              var c = a(["color", "background", "size"]), l = c.next();
              !l.done;
              l = c.next()
            ) {
              var u = l.value;
    ...
    ((d.Quantity = function (t, e, r, a, n, u, d) {
      ...
      if ("\\" === h) {
        if ((t.i++, !(v = t.GetCS()).match(f))) {
          ...
          return (
            t.Push(c.default.fenced(t.configuration, r, y, a)),
            void (t.i = g)
          );
        }
        h = t.GetNext();
      ...
      if (u) {
        ...
        (d && l.default.setAttribute(b, "mathvariant", d),
      ...
      m = (function (t) {
        ...
        return (
          ...
          (e.prototype.PushMath = function (t) {
            ...
            try {
              for (
                var n = o(["mathsize", "mathcolor"]), i = n.next();
                !i.done;
                i = n.next()
              ) {
                var s = i.value;
          ...
          (e.prototype.addAttributes = function (t) {
            ...
            if (t.isToken)
              try {
                for (
                  var n = o(["mathsize", "mathcolor", "mathvariant"]),
                    i = n.next();
                  !i.done;
                  i = n.next()
                ) {
