      ...
      c = (function () {
        function t(t, e, r) {
          ...
          if ((delete e.isInner, e)) {
            ...
            try {
              for (
                var c = n(Object.keys(e)), p = c.next();
                !p.done;
                p = c.next()
              ) {
                var f = p.value;
        ...
        function b(t, e) {
          for (
            ...
            switch (c) {
              ...
              default:
                if (!n && -1 !== e.indexOf(c))
                  return [l ? "true" : v(i, a), c, t.slice(o)];
                ((s = !1), (l = !1));
            }
            i += c;
          }
            ...
            for (var r = 0, n = e.length; r < n; r++) {
              ...
              if (
                ...
                if (
                  ...
                  (s.default.isType(i, "TeXAtom") &&
                    s.default.getTexClass(i) === a.TEXCLASS.REL)
                ) {
              ...
              for (; p < e.length; )
                if ("$" === (i = e.charAt(p++)))
                  ...
                  if ("" === h && e.substr(p).match(/^(eq)?ref\s*\{/)) {
                    ...
                    "(" === (i = e.charAt(p++)) && "" === h
                      ? (f < p - 2 && c.push(g(t, e.slice(f, p - 2), s)),
                        (h = ")"),
                        (f = p))
                      : ")" === i && ")" === h && 0 === d
                        ? ((o = t.create("node", "TeXAtom", [
  ...
  function (t, e, r) {
    ...
    var f = (function () {
      function t(t) {
        ...
        try {
          for (
            var a = n(t.slice().reverse()), c = a.next();
            !c.done;
            c = a.next()
          ) {
            var p = c.value;
      ...
      return (
        ...
        (e.prototype.parse = function (t) {
          var e = o(t, 2),
            ...
            a = this.parserFor(n);
          return i && a
            ? a.apply(void 0, s([r, i.symbol], i.args)) || !0
            : null;
        }),
        e
      );
    ...
    var y = (function (t) {
      function e(r) {
        ...
        (n = t.call(this, s) || this).findTeX =
          n.options.FindTeX || new u.FindTeX(p);
        var f = n.options.packages,
          h = (n.configuration = e.configure(f)),
          g = (n._parseOptions = new d.default(h, [
            n.options,
  ...
  function (t, e, r) {
    ...
    (!(function (t) {
      ((t.cleanStretchy = function (t) {
        ...
        try {
          for (
            var o = n(i.getList("fixStretchy")), s = o.next();
            !s.done;
            s = o.next()
          ) {
            var l = s.value;
        ...
        (t.cleanAttributes = function (t) {
          t.data.root.walkTree(function (t, e) {
            ...
            if (o)
              try {
                for (
                  var a = n(o.getExplicitNames()), s = a.next();
                  !s.done;
                  s = a.next()
                ) {
                  var l = s.value;
  ...
  function (t, e, r) {
    ...
    ((h.Open = function (t, e) {
      ...
      (h.Accent = function (t, e, r, n) {
        ...
        o.default.isType(c, "mo") &&
          o.default.setProperties(c, { movablelimits: !1 });
        var p = t.create("node", "munderover");
        (o.default.setChild(p, 0, i),
      ...
      (h.Phantom = function (t, e, r, n) {
        ...
        (r || n) &&
          ...
          n &&
            (o.default.setAttribute(i, "height", 0),
            o.default.setAttribute(i, "depth", 0)),
      ...
      (h.BuildRel = function (t, e) {
        var r = t.ParseUpTo(e, "\\over"),
          n = t.ParseArg(e),
          i = t.create("node", "munderover");
        (o.default.setChild(i, 0, n),
          o.default.setChild(i, 1, null),
          o.default.setChild(i, 2, r));
      ...
      (h.Dots = function (t, e) {
        ...
        t.Push(
          t.itemFactory.create("dots").setProperties({ ldots: i, cdots: a }),
        );
      }),
      ...
      (h.Entry = function (t, e) {
        if (
          ...
          for (
            var r = t.string, n = 0, i = -1, o = t.i, s = r.length;
            o < s;
      ...
      (h.CrLaTeX = function (t, e, r) {
        ...
        if (d instanceof i.ArrayItem) {
          if (o && d.arraydef.rowspacing) {
            ...
            for (
              var y = d.getProperty("rowspacing");
              m.length < d.table.length;

            )
              m.push(u.default.Em(y));
            ((m[d.table.length - 1] = u.default.Em(
              Math.max(0, y + u.default.dimen2em(o)),
            )),
  ...
  function (t, e, r) {
    ...
    (new n.RegExpMap("letter", a.default.variable, /[a-z]/i),
      ...
      new n.CharacterMap("mathchar0mi", a.default.mathchar0mi, {
        ...
        prime: [
          "\u2032",
          { mathvariant: i.TexConstant.Variant.NORMAL, variantForm: !0 },
        ],
