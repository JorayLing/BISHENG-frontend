      ...
      return (
        ...
        (e.prototype.parse = function (t) {
          var e = i(t, 2),
            ...
            o = this.parserFor(n);
          return a && o
            ? o.apply(void 0, s([r, a.symbol], a.args)) || !0
            : null;
        }),
        e
      );
      ...
      (function (t) {
        ...
        function b(t, e) {
          for (
            ...
            switch (c) {
              ...
              default:
                if (!n && -1 !== e.indexOf(c))
                  return [l ? "true" : v(a, o), c, t.slice(i)];
                ((s = !1), (l = !1));
            }
            a += c;
          }
        ...
        ((t.matchDimen = d),
          ...
          (t.fenced = function (t, e, r, n, a) {
            ...
            var i,
              u = t.nodeFactory,
              c = u.create("node", "mrow", [], {
                open: e,
                close: n,
                texClass: o.TEXCLASS.INNER,
              });
            if (a)
              i = new l.default(
                "\\" + a + "l" + e,
            ...
            for (var r = 0, n = e.length; r < n; r++) {
              ...
              if (
                ...
                if (
                  ...
                  (s.default.isType(a, "TeXAtom") &&
                    s.default.getTexClass(a) === o.TEXCLASS.REL)
                ) {
  ...
  function (t, e, r) {
    ...
    var p = (function () {
      function t(t) {
        ...
        try {
          for (
            var o = n(t.slice().reverse()), c = o.next();
            !c.done;
            c = o.next()
          ) {
            var f = c.value;
        ...
        try {
          for (
            var p = n(this.configurations), d = p.next();
            !d.done;
            d = p.next()
          ) {
            var h = d.value,
      ...
      return (
        ...
        (t.prototype.config = function (t) {
          ...
          try {
            for (
              var a = n(this.configurations), i = a.next();
              !i.done;
              i = a.next()
            ) {
              var o = i.value;
        ...
        (t.prototype.add = function (t, e, r) {
          ...
          try {
            for (
              var l = n(Object.keys(t.items)), u = l.next();
              !u.done;
              u = l.next()
            ) {
              var f = u.value;
      ...
      (function (t) {
        ...
        ((t.OPTIONS = {
          ...
          (t.addTags = function (e) {
            ...
            try {
              for (
                var a = i(Object.keys(e)), o = a.next();
                !o.done;
                o = a.next()
              ) {
                var s = o.value;
    ...
    var u = (function () {
      ...
      return (
        ...
        (t.prototype.retrieve = function (t) {
          ...
          try {
            for (
              var a = n(this.map.values()), i = a.next();
              !i.done;
              i = a.next()
            ) {
  ...
  function (t, e, r) {
    ...
    ((d.Open = function (t, e) {
      ...
      (d.Accent = function (t, e, r, n) {
        ...
        i.default.isType(c, "mo") &&
          i.default.setProperties(c, { movablelimits: !1 });
        var f = t.create("node", "munderover");
        (i.default.setChild(f, 0, a),
          i.default.setChild(f, 1, null),
          i.default.setChild(f, 2, l));
      ...
      (d.MmlToken = function (t, e) {
        ...
        if (!r || !r.isToken)
          throw new o.default("NotMathMLToken", "%1 is not a token element", n);
        for (; "" !== a; ) {
          ...
          var f = u.default.MmlFilterAttribute(
            t,
            c[1],
            c[2].replace(/^(['"])(.*)\1$/, "$2"),
          );
      ...
      (d.Entry = function (t, e) {
        if (
          ...
          for (
            var r = t.string, n = 0, a = -1, i = t.i, s = r.length;
            i < s;
      ...
      (d.CrLaTeX = function (t, e, r) {
        ...
        if (h instanceof a.ArrayItem) {
          if (i && h.arraydef.rowspacing) {
            ...
            for (
              var y = h.getProperty("rowspacing");
              m.length < h.table.length;

            )
              m.push(u.default.Em(y));
            ((m[h.table.length - 1] = u.default.Em(
              Math.max(0, y + u.default.dimen2em(i)),
            )),
      ...
      (d.BeginEnd = function (t, e) {
        ...
        if (r.match(/\\/i))
          throw new o.default("InvalidEnv", "Invalid environment name '%1'", r);
      ...
      (d.HandleLabel = function (t, e) {
        ...
        if ("" !== r && !t.tags.refUpdate) {
          if (t.tags.label)
            throw new o.default("MultipleCommand", "Multiple %1", t.currentCS);
          if (
            ((t.tags.label = r),
  ...
  function (t, e, r) {
    ...
    ((e.AmsMethods = {}),
      ...
      (e.AmsMethods.AlignAt = function (t, r, a, i) {
        ...
        for (var p = parseInt(o, 10); p > 0; )
          ((c += "rl"), f.push("0em 0em"), p--);
        var d = f.join(" ");
      ...
      l = {
        ...
        MacroWithTemplate: function (t, e, r, a) {
          ...
          if (u) {
            ...
            for (var f = 0; f < u; f++)
              c.push(s.default.GetParameter(t, e, i[f + 1]));
        ...
        BeginEnv: function (t, e, r, n, a, i) {
          ...
          if (a) {
            ...
            ((r = o.default.substituteArgs(t, l, r)),
              (n = o.default.substituteArgs(t, [], n)));
          }
          return (
            (t.string = o.default.addArgs(t, r, t.string.slice(t.i))),
            (t.i = 0),
        ...
        return (
          ...
          (e.prototype.addPattern = function (t, e, r) {
            ...
            (t.push(s.quotePattern(a)),
              (this.end[a] = [o, r, this.endPattern(o)]));
          }),
  ...
  function (t, e, r) {
    ...
    (!(function (t) {
      ((t.cleanStretchy = function (t) {
        ...
        try {
          for (
            var i = n(a.getList("fixStretchy")), s = i.next();
            !s.done;
            s = i.next()
          ) {
            var l = s.value;
            if (o.default.getProperty(l, "fixStretchy")) {
              ...
              u &&
                u[3] &&
                u[3].stretchy &&
                o.default.setAttribute(l, "stretchy", !1);
              var c = l.parent;
        ...
        (t.cleanAttributes = function (t) {
          t.data.root.walkTree(function (t, e) {
            ...
            if (i)
              try {
                for (
                  var o = n(i.getExplicitNames()), s = o.next();
                  !s.done;
                  s = o.next()
                ) {
                  var l = s.value;
        ...
        (t.combineRelations = function (t) {
          ...
          try {
            for (
              var l = n(t.data.getList("mo")), u = l.next();
              !u.done;
              u = l.next()
            ) {
              var c = u.value;
              if (
                ...
                for (
                  ...
                  if (
                    m !== o.default.getProperty(p, "variantForm") ||
                    !r(c, p)
                  ) {
          ...
          for (var s = n(t.getList(e)), l = s.next(); !l.done; l = s.next()) {
            ...
            if (!u.attributes.get("displaystyle")) {
              ...
              if (
                ...
                !f.attributes.getExplicit("movablelimits")
              ) {
          ...
          (t.prototype.Push = function () {
            ...
            try {
              for (var l = n(r), u = l.next(); !u.done; u = l.next()) {
                var c = u.value;
                if (c) {
                  var f = o.default.isNode(c)
                    ? this._factory.create("mml", c)
                    : c;
                  f.global = this.global;
                  var p = a(
                      this.stack.length ? this.Top().checkItem(f) : [null, !0],
                      2,
                    ),
                    d = p[0],
                    h = p[1];
          ...
          (t.createNode = function (t, e, r, n, a) {
            ...
            if (s === 1 / 0 || -1 === s)
              ...
              for (var l = [], u = 0, c = void 0; (c = r[u]); u++)
                if (c.isInferred) {
                  var f = t.mmlFactory.create(
                    "mrow",
                    {},
                    i.default.getChildren(c),
                  );
      ...
      config: function (t, e) {
        ...
        try {
          for (var b = a(Object.keys(v)), A = b.next(); !A.done; A = b.next()) {
            ...
            try {
              for (
                var P = ((o = void 0), a(w)), C = P.next();
                !C.done;
                C = P.next()
              ) {
                var O = C.value;
                (g.lookup(O) && "color" !== O) ||
                  p.add(O, new s.Macro(O, f, [M, !0]));
              }
            } catch (t) {
              o = { error: t };
            } finally {
