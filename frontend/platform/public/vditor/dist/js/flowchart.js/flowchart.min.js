          ...
          (n = function (t) {
            ...
            ((Wt.animateWith = function (t, r, i, n, a, s) {
              ...
              (Wt.setTime = function (t, e) {
                return (
                  t && null != e && this.status(t, k(e, t.ms) / t.ms),
                  this
                );
              }),
  ...
  return (function (t) {
    ...
    function (t, i) {
      function e(t, i) {
        ...
        for (n in t)
          t[n] &&
            ("object" == typeof s[n] ? (s[n] = e(s[n], t[n])) : (s[n] = t[n]));
        return s;
      }
      function s(t, i) {
    ...
    function (t, i, e) {
      function s(t, i, e) {
        ...
        if (o) {
          for (
            var r = i.text.split(" "), a = "", l = 0, p = r.length;
            l < p;
            l++
          ) {
            var y = r[l];
          ...
          if (this.next) {
            ...
            if ("right" === this.next_direction) {
              ...
              this.next.isPositioned ||
                ...
                (function e() {
                  for (
                    var s, n = !1, h = 0, o = t.chart.symbols.length;
                    h < o;
                    h++
                  ) {
                    s = t.chart.symbols[h];
                    ...
                    if (
                      s.getCenter().y > t.next.getCenter().y &&
                      r <= t.next.width / 2
                    ) {
                      n = !0;
                      break;
        ...
        (s.prototype.drawLineTo = function (t, i, e) {
          ...
          if ((e && "bottom" !== e) || !u || !_)
            if ((e && "right" !== e) || !b || !L)
              if ((e && "left" !== e) || !b || !w)
                  ...
                  if ((e && "right" !== e) || !u || !_)
                    if ((e && "bottom" !== e) || !w)
                      if ((e && "bottom" !== e) || !L || !_)
                        ...
                        ((n =
                          10 *
                          Math.max(t.topLines.length, this.bottomLines.length)),
                          (s = h(
                            this.chart,
                            p,
                            [
                    ...
                    ((n =
                      10 * Math.max(t.topLines.length, this.rightLines.length)),
                      (s = h(
                        this.chart,
                        l,
                        [
                ...
                (0 === t.rightLines.length && 0 === this.leftLines.length
                  ...
                  : ((n =
                      10 *
                      Math.max(t.rightLines.length, this.leftLines.length)),
                    (s = h(
                      this.chart,
                      l,
                      [
              ...
              (0 === t.leftLines.length && 0 === this.rightLines.length
                ...
                : ((n =
                    10 * Math.max(t.leftLines.length, this.rightLines.length)),
                  (s = h(
                    this.chart,
                    l,
                    [
            ...
            (0 === t.topLines.length && 0 === this.bottomLines.length
              ...
              : ((n =
                  10 * Math.max(t.topLines.length, this.bottomLines.length)),
                (s = h(
                  this.chart,
                  p,
                  [
              ...
              (k = p.x));
          if (
            (this.lineStyle[t.key] && s && s.attr(this.lineStyle[t.key]), s)
          ) {
    ...
    function (t, i) {
      ...
      function s(t, i, e, s) {
        ...
        var o = "M{0},{1}";
        for (n = 2, h = 2 * e.length + 2; n < h; n += 2)
          o += " L{" + n + "},{" + (n + 1) + "}";
        var r = [i.x, i.y];
          ...
          (x
            ? ((m = i.x > d.x ? i.x - (i.x - d.x) / 2 : d.x - (d.x - i.x) / 2),
              ...
              c
                ...
                : ((m += t.options["text-margin"]),
                  (u -= g.getBBox().height / 2)))
            : ((m = i.x),
              (u = i.y),
              c
                ? (i.x > d.x
          ...
          if (L.indexOf("=>") >= 0) {
            ...
            if (
              ...
              B.symbolType.indexOf("\n") >= 0 &&
                (B.symbolType = B.symbolType.split("\n")[0]),
              B.link)
            ) {
        ...
        (s.prototype.render = function () {
          ...
          if (this.right_symbol) {
            ...
            if (!this.right_symbol.isPositioned) {
              ...
              (!(function i() {
                for (
                  var e, n = !1, h = 0, o = s.chart.symbols.length;
                  h < o;
                  h++
                )
                  if (
                    ...
                    var r = Math.abs(
                      e.getCenter().x - s.right_symbol.getCenter().x,
                    );
                    if (
              ...
              (!(function i() {
                for (
                  ...
                  if (
                    ...
                    var r = Math.abs(
                      e.getCenter().x - s.left_symbol.getCenter().x,
                    );
                    if (
            ...
            arguments.length > 1 &&
              ...
              s != s
                ...
                : 0 !== s &&
                  ...
                  (s = (s > 0 || -1) * Math.floor(Math.abs(s))));
            for (
              var n = s >= 0 ? Math.min(s, e - 1) : e - Math.abs(s);
              n >= 0;
              n--
            )
              if (n in i && i[n] === t) return n;
      ...
      if ("undefined" != typeof jQuery) {
        ...
        !(function (t) {
          function i(t, i) {
            return (
              t == i ||
              (Array.isArray(i) && (i.includes(t) || i.includes(Number(t))))
            );
          }
          var e = {
            init: function (i) {
          ...
          t.fn.flowChart = function (i) {
            return e[i]
              ...
              : "object" != typeof i && i
                ? void t.error(
                    "Method " + i + " does not exist on jQuery.flowChart",
                  )
