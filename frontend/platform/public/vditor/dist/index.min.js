          ...
          ((t.Diff = function (e, t) {
            ...
            (t.prototype.diff_compute_ = function (e, r, i, o) {
              ...
              if (-1 != c)
                return (
                  (a = [
                    new t.Diff(1, l.substring(0, c)),
                    new t.Diff(0, s),
                    new t.Diff(1, l.substring(c + s.length)),
                  ]),
            ...
            (t.prototype.diff_lineMode_ = function (e, r, i) {
              ...
              (this.diff_charsToLines_(l, a),
                ...
                l.push(new t.Diff(0, "")));
              for (var s = 0, c = 0, d = 0, u = "", p = ""; s < l.length; ) {
                switch (l[s][0]) {
                  case 1:
                    (d++, (p += l[s][1]));
                    break;
              ...
              function i(e) {
                for (
                  ...
                  ((r.hasOwnProperty ? r.hasOwnProperty(s) : void 0 !== r[s])
                    ...
                    : (l == o && ((s = e.substring(i)), (a = e.length)),
            ...
            (t.prototype.diff_commonOverlap_ = function (e, t) {
              ...
              for (var o = 0, a = 1; ; ) {
                ...
                if (-1 == s) return o;
                ((a += s),
                  (0 != s && e.substring(i - a) != t.substring(0, a)) ||
                    ((o = a), a++));
              }
            }),
            (t.prototype.diff_halfMatch_ = function (e, t) {
              ...
              return u || p
                ? ((a = p ? (u && u[4].length > p[4].length ? u : p) : u),
                  e.length > t.length
                    ? ((l = a[0]), (s = a[1]), (c = a[2]), (d = a[3]))
                    : ((c = a[0]), (d = a[1]), (l = a[2]), (s = a[3])),
                  [l, s, c, d, a[4]])
                : null;
            }),
                ...
                if (e[l - 1][0] == n && 1 == e[l][0]) {
                  ...
                  (f >= h
                    ? (f >= p.length / 2 || f >= m.length / 2) &&
                      (e.splice(l, 0, new t.Diff(0, m.substring(0, f))),
                      (e[l - 1][1] = p.substring(0, p.length - f)),
                      (e[l + 1][1] = m.substring(f)),
                      l++)
                    : (h >= p.length / 2 || h >= m.length / 2) &&
                      (e.splice(l, 0, new t.Diff(0, p.substring(0, h))),
                      (e[l - 1][0] = 1),
            ...
            (t.prototype.diff_cleanupEfficiency = function (e) {
              for (
                ...
                (0 == e[l][0]
                  ? (e[l][1].length < this.Diff_EditCost && (d || u)
                      ? ((i[o++] = l), (s = d), (c = u), (a = e[l][1]))
                      : ((o = 0), (a = null)),
                    (d = u = !1))
                  : (e[l][0] == n ? (u = !0) : (d = !0),
                    a &&
                ...
                switch (e[i][0]) {
                  ...
                  case 0:
                    (o + a > 1
                      ? (0 !== o &&
                          0 !== a &&
                          (0 !== (r = this.diff_commonPrefix(s, l)) &&
                            (i - o - a > 0 && 0 == e[i - o - a - 1][0]
                              ? (e[i - o - a - 1][1] += s.substring(0, r))
                              : (e.splice(
                                  0,
                                  0,
                                  new t.Diff(0, s.substring(0, r)),
                                ),
                                i++),
                            (s = s.substring(r)),
                            (l = l.substring(r))),
                          0 !== (r = this.diff_commonSuffix(s, l)) &&
                            ((e[i][1] = s.substring(s.length - r) + e[i][1]),
                            (s = s.substring(0, s.length - r)),
                            (l = l.substring(0, l.length - r)))),
                        (i -= o + a),
                        e.splice(i, o + a),
                        l.length && (e.splice(i, 0, new t.Diff(n, l)), i++),
                        s.length && (e.splice(i, 0, new t.Diff(1, s)), i++),
                        i++)
                      : 0 !== i && 0 == e[i - 1][0]
            ...
            (t.prototype.diff_prettyHtml = function (e) {
              for (
                ...
                switch (s) {
                  case 1:
                    t[l] = '<ins style="background:#e6ffe6;">' + c + "</ins>";
                    break;
                  case n:
                    t[l] = '<del style="background:#ffe6e6;">' + c + "</del>";
                    break;
                  case 0:
                    t[l] = "<span>" + c + "</span>";
                }
            ...
            (t.prototype.diff_fromDelta = function (e, r) {
              for (
                var i = [], o = 0, a = 0, l = r.split(/\t/g), s = 0;
                s < l.length;
                s++
              ) {
                var c = l[s].substring(1);
                switch (l[s].charAt(0)) {
                  case "+":
                    try {
                  ...
                  default:
                    if (l[s])
                      throw new Error(
                        "Invalid diff operation in diff_fromDelta: " + l[s],
                      );
                }
              }
              if (a != e.length)
            ...
            (t.prototype.match_bitap_ = function (e, t, n) {
              ...
              -1 != l &&
                ((a = Math.min(o(0, l), a)),
                -1 != (l = e.lastIndexOf(t, n + t.length)) &&
                  (a = Math.min(o(0, l), a)));
              var s,
                c,
                d = 1 << (t.length - 1);
            ...
            (t.prototype.patch_make = function (e, r, i) {
              ...
              for (
                ...
                var h = a[f][0],
                  v = a[f][1];
                switch ((c || 0 === h || ((s.start1 = d), (s.start2 = u)), h)) {
                  case 1:
                    ((s.diffs[c++] = a[f]),
                      (s.length2 += v.length),
                  ...
                  case n:
                    ...
                    break;
                  case 0:
                    v.length <= 2 * this.Patch_Margin && c && a.length != f + 1
                      ? ((s.diffs[c++] = a[f]),
                        (s.length1 += v.length),
                        (s.length2 += v.length))
                      : v.length >= 2 * this.Patch_Margin &&
                        c &&
                        (this.patch_addContext_(s, p),
                        l.push(s),
                        (s = new t.patch_obj()),
                        (c = 0),
                        (p = m),
                ...
                (1 !== h && (d += v.length), h !== n && (u += v.length));
              }
              return (c && (this.patch_addContext_(s, p), l.push(s)), l);
            }),
              ...
              for (var i = 0, o = [], a = 0; a < e.length; a++) {
                ...
                if (
                  ...
                  d ==
                    (s =
                      -1 == u
                        ? t.substring(l, l + d.length)
                        : t.substring(l, u + this.Match_MaxBits)))
                )
                  t =
                    t.substring(0, l) +
                    this.diff_text2(e[a].diffs) +
                    t.substring(l + d.length);
                else {
                  var p = this.diff_main(d, s, !1);
                  if (
                    d.length > this.Match_MaxBits &&
                    ...
                    for (var m, f = 0, h = 0; h < e[a].diffs.length; h++) {
                      ...
                      (0 !== v[0] && (m = this.diff_xIndex(p, f)),
                        1 === v[0]
                          ? (t =
                              t.substring(0, l + m) + v[1] + t.substring(l + m))
                          : v[0] === n &&
                            (t =
                              t.substring(0, l + m) +
                              t.substring(
                                l + this.diff_xIndex(p, f + v[1].length),
                              )),
                        v[0] !== n && (f += v[1].length));
                    }
                  }
                ...
                for (
                  r.push(s),
                    ...
                    "" === l[2]
                      ...
                      : "0" == l[2]
                        ? (s.length1 = 0)
                        : (s.start1--, (s.length1 = parseInt(l[2], 10))),
                    s.start2 = parseInt(l[3], 10),
                    "" === l[4]
                      ? (s.start2--, (s.length2 = 1))
                      : "0" == l[4]
                        ? (s.length2 = 0)
                        : (s.start2--, (s.length2 = parseInt(l[4], 10))),
                    o++;
                  o < i.length;
                  ...
                  if ("-" == c) s.diffs.push(new t.Diff(n, d));
                  else if ("+" == c) s.diffs.push(new t.Diff(1, d));
                  else if (" " == c) s.diffs.push(new t.Diff(0, d));
                  else {
                    if ("@" == c) break;
                    if ("" !== c)
                      throw new Error(
                      ...
                      if (
                        ...
                        return (
                          o.classList.contains("vditor-speech--current")
                            ...
                            : ((l.text = o.getAttribute("data-text")),
              ...
              return C(void 0, void 0, void 0, function () {
                ...
                return M(this, function (S) {
                  switch (S.label) {
                    ...
                    case 2:
                      return (
                        (k = (y = "vditorI18nScript") + i.lang),
                        document
                          .querySelectorAll('head script[id^="'.concat(y, '"]'))
                          .forEach(function (e) {
                    ...
                    case 4:
                      return [3, 6];
                    case 5:
                      ((window.VditorI18n = i.i18n), (S.label = 6));
                    case 6:
                      return i.icon
                        ? [
                            4,
                    ...
                    case 8:
                      return (
                        (0, b.Z)(i.theme.current, i.theme.path),
                        1 === i.anchor &&
                        ...
                        0 !== i.anchor &&
                          ...
                          document
                            ...
                            .forEach(function (e) {
                              (1 === L &&
                                e.classList.add("vditor-anchor--left"),
                                (e.onclick = function () {
                    ...
                    if (
                      ...
                      try {
                        ...
                        new Viz({ worker: i })
                          ...
                          .catch(function (t) {
                            ((e.innerHTML =
                              "graphviz render error: <br>".concat(t)),
                              (e.className = "vditor-reset--error"));
                          });
                      } catch (e) {
        ...
        702: (e, t, n) => {
          ...
          var r = n(793),
            ...
            a = function (e, t, n) {
              ...
              (0, o.c)(
                "".concat(n, "/dist/js/highlight.js/styles/").concat(a, ".css"),
                "vditorHljsStyle",
              ),
              !1 !== e.enable) &&
                      ...
                      (0, i.G)(
                        ...
                        n.forEach(function (e) {
                          if (
                            ...
                            var n = (0, a.X)(l.mathRenderAdapter.getCode(e));
        ...
        182: (e, t, n) => {
          ...
          var r = n(946),
            ...
            o = function (e, t, n) {
                ...
                (n.lute.SetToC(!0),
                  "wysiwyg" !== n.currentMode || n.preview.element.contains(e)
                    ? "ir" !== n.currentMode || n.preview.element.contains(e)
                      ? (l.innerHTML = n.lute.HTML2VditorDOM(
                          "<p>[ToC]</p>" + o,
                        ))
                      : (l.innerHTML = n.lute.SpinVditorIRDOM(
                          "<p>[ToC]</p>" + o,
                        ))
                    : (l.innerHTML = n.lute.SpinVditorDOM("<p>[ToC]</p>" + o)),
              ...
              var c = l.firstElementChild.querySelectorAll(
              ...
              return (
                c.forEach(function (e, t) {
                  if (
                    ...
                    e.innerHTML = "<svg></svg><span>".concat(
                      e.innerHTML,
                      "</span>",
                    );
        ...
        971: (e, t, n) => {
          ...
          var r = function (e, t, n) {
            ...
            a.addEventListener("click", function () {
              ...
              ((t / 90) % 2 == 1 &&
              e.naturalWidth > i.parentElement.clientHeight
          ...
          var r = n(793),
            ...
            l = function (e) {
              ...
              if (0 === t.getClientRects().length)
                if (3 === t.startContainer.nodeType) {
                  ...
                  if (!n) {
                    for (
                      var s = t.startContainer.childNodes[t.startOffset];
                      !s.getClientRects ||
                      (s.getClientRects && 0 === s.getClientRects().length);
            ...
            u = function (e, t, n) {
              ...
              for (s.setStart(o || n, 0), s.collapse(!0); !l && o; ) {
                ...
                if (
                  ...
                  (0 === e
                    ...
                    : 3 === o.childNodes[0].nodeType
                      ? s.setStart(o.childNodes[0], e - r)
                      : o.nextSibling
                        ? s.setStartBefore(o.nextSibling)
                        : s.setStartAfter(o),
                  (a = !0),
                  e === t)
                ) {
                ...
                (a &&
                  ...
                  (0 === t
                    ? s.setEnd(o, 0)
                    : 3 === o.childNodes[0].nodeType
                      ? s.setEnd(o.childNodes[0], t - r)
                      : o.nextSibling
                        ? s.setEndBefore(o.nextSibling)
                        : s.setEndAfter(o),
                  (l = !0)),
                  (r = d),
                  (o = n.childNodes[++i]));
              ...
              return (
                !l &&
                  n.childNodes[i - 1] &&
                  s.setStartBefore(n.childNodes[i - 1]),
                c(s),
                s
              );
            },
      ...
      (() => {
        ...
        var e,
          ...
          N = function (e, t) {
            if (e)
              if ("html-block" !== e.parentElement.getAttribute("data-type")) {
                ...
                if ("abc" === n) (0, E.Q)(e, t.options.cdn);
                else if ("mermaid" === n)
                  (0, A.i)(e, t.options.cdn, t.options.theme);
                else if ("markmap" === n)
                  (0, x.K)(e, t.options.cdn, t.options.theme);
                else if ("flowchart" === n) (0, L.P)(e, t.options.cdn);
                else if ("echarts" === n)
                  (0, k.p)(e, t.options.cdn, t.options.theme);
                else if ("mindmap" === n)
                  (0, _.P)(e, t.options.cdn, t.options.theme);
                else if ("plantuml" === n) (0, H.B)(e, t.options.cdn);
                else if ("graphviz" === n) (0, T.v)(e, t.options.cdn);
                else if ("math" === n)
                  (0, M.H)(e, {
                    cdn: t.options.cdn,
                  ...
                  t.options.customRenders.find(function (r) {
                    ...
                    (0, S.O)(e, t.options.preview.hljs));
                }
          ...
          j = function (e, t, n, r) {
            if (
              ...
              if (
                "Backspace" === n.key &&
                0 === (0, O.im)(e, t[t.currentMode].element, r).start
              )
                return (e.previousElementSibling.remove(), dt(t), !0);
              if (rt(t, n, r, e, e.previousElementSibling)) return !0;
            }
            if (
              e.nextElementSibling &&
              ...
              if (
                "Delete" === n.key &&
                (0, O.im)(e, t[t.currentMode].element, r).start >=
                  e.textContent.trimRight().length
              )
                return (e.nextElementSibling.remove(), dt(t), !0);
              if (nt(t, n, r, e, e.nextElementSibling)) return !0;
            }
          ...
          R = function (e, t, n, r) {
            ...
            if (o && !n && "code-block" !== o.getAttribute("data-type")) {
              if (
                (st(o.innerHTML) && o.previousElementSibling) ||
                ct(o.innerHTML)
              )
                return;
              for (
                var l = (0, O.im)(o, e.ir.element, t).start, s = !0, c = l - 1;
                c > o.textContent.substr(0, l).lastIndexOf("\n");
                c--
              )
                if (
              ...
              0 === l && (s = !1);
              var d = !0;
              for (c = l - 1; c < o.textContent.length; c++)
                if (
                  " " !== o.textContent.charAt(c) &&
                  "\n" !== o.textContent.charAt(c)
                ) {
            ...
            var m,
              ...
              h = (0, y.a1)(o, "data-type", "footnotes-block"),
              v = "";
            if (f) v = o.innerHTML;
            else {
              ...
              if (
                ...
                (!k ||
                  ...
                  ((v = k.outerHTML + v), k.remove()),
                  !S ||
                    ("UL" !== S.tagName && "OL" !== S.tagName) ||
                    ((v += S.outerHTML), S.remove()),
                  (v = v.replace(
                    "<div><wbr><br></div>",
                    "<li><p><wbr><br></p></li>",
                  )));
                ...
                o.previousElementSibling &&
                  ...
                  ((v = o.previousElementSibling.outerHTML + v),
            ...
            var A,
              x = e.ir.element.querySelectorAll(
            ...
            (x.forEach(function (e, t) {
              ...
              x.length > 0 &&
                e.ir.element.insertAdjacentElement("beforeend", x[0]));
            var _ = e.ir.element.querySelectorAll(
              "[data-type='footnotes-block']",
            );
            (_.forEach(function (e, t) {
              0 === t
                ? (A = e)
                : (A.insertAdjacentHTML("beforeend", e.innerHTML), e.remove());
            }),
              _.length > 0 &&
                e.ir.element.insertAdjacentElement("beforeend", _[0]),
              (0, O.ib)(e.ir.element, t),
              e.ir.element
          ...
          B = n(971),
          V = function (e, t) {
            e.querySelectorAll("[data-type=footnotes-link]").forEach(
              function (e) {
                for (
          ...
          U = function (e, t) {
            ...
            if (
              ...
              for (
                var a = (0, O.im)(o, e.sv.element, r).start, l = !0, s = a - 1;
                s > o.textContent.substr(0, a).lastIndexOf("\n");
                s--
              )
                if (
                  " " !== o.textContent.charAt(s) &&
                  "\t" !== o.textContent.charAt(s)
                ) {
                  l = !1;
                  break;
                }
              if ((0 === a && (l = !1), l)) return void je(e);
              if ("deleteContentBackward" === t.inputType) {
                var c =
                  (0, y.a1)(i, "data-type", "code-block-open-marker") ||
                  (0, y.a1)(i, "data-type", "code-block-close-marker");
                if (c) {
                  var d;
                  if ("code-block-close-marker" === c.getAttribute("data-type"))
                    if ((d = Oe(i, "code-block-open-marker")))
                      return ((d.textContent = c.textContent), void je(e));
                  if ("code-block-open-marker" === c.getAttribute("data-type"))
                    if ((d = Oe(i, "code-block-close-marker", !1)))
                      return ((d.textContent = c.textContent), void je(e));
                }
                ...
                if (m && -1 === m.textContent.indexOf("#")) return void je(e);
              }
              if (
                (" " === t.data || "deleteContentBackward" === t.inputType) &&
                ((0, y.a1)(i, "data-type", "padding") ||
                  (0, y.a1)(i, "data-type", "li-marker") ||
                  (0, y.a1)(i, "data-type", "task-marker") ||
                  (0, y.a1)(i, "data-type", "blockquote-marker"))
              )
                return void je(e);
            }
            if (o && "$$" === o.textContent.trimRight()) je(e);
            else {
              (o || (o = e.sv.element),
                "link-ref-defs-block" ===
                ...
                (0, y.a1)(i, "data-type", "footnotes-link") &&
                  (o = e.sv.element),
        ...
        var Z,
              ...
              (e[e.currentMode].hlToolbarTimeoutId = window.setTimeout(
                function () {
                  if (
                    ...
                    (0, O.Gb)(e[e.currentMode].element)
                  ) {
                    ...
                    (3 === t.startContainer.nodeType &&
                      ...
                      ("sv" === e.currentMode
                        ? (0, y.a1)(n, "data-type", "heading")
                        : (0, b.W)(n)) && u(e.toolbar.elements, ["headings"]),
                      ("sv" === e.currentMode
                        ? (0, y.a1)(n, "data-type", "blockquote")
                        : (0, y.lG)(n, "BLOCKQUOTE")) &&
                        u(e.toolbar.elements, ["quote"]),
                      (0, y.a1)(n, "data-type", "strong") &&
                        u(e.toolbar.elements, ["bold"]),
                      (0, y.a1)(n, "data-type", "em") &&
                        u(e.toolbar.elements, ["italic"]),
                      (0, y.a1)(n, "data-type", "s") &&
                        u(e.toolbar.elements, ["strike"]),
                      (0, y.a1)(n, "data-type", "a") &&
              ...
              (e.wysiwyg.hlToolbarTimeoutId = window.setTimeout(function () {
                if (
                  ...
                  (o
                    ...
                    (0, y.lG)(n, "BLOCKQUOTE") &&
                      u(e.toolbar.elements, ["quote"]),
                    ((0, y.lG)(n, "B") || (0, y.lG)(n, "STRONG")) &&
                      u(e.toolbar.elements, ["bold"]),
                    ((0, y.lG)(n, "I") || (0, y.lG)(n, "EM")) &&
                      u(e.toolbar.elements, ["italic"]),
                    ((0, y.lG)(n, "STRIKE") || (0, y.lG)(n, "S")) &&
                      u(e.toolbar.elements, ["strike"]),
                    e.wysiwyg.element
                  ...
                  var l = (0, y.fb)(n, "vditor-comment");
                  if (l) {
                    var s = l.getAttribute("data-cmtids").split(" ");
                    if (
                      s.length > 1 &&
                      l.nextSibling.isSameNode(l.nextElementSibling)
                    ) {
                      var f = l.nextElementSibling
                        .getAttribute("data-cmtids")
                        .split(" ");
                      s.find(function (e) {
                        if (f.includes(e)) return ((s = [e]), !0);
                      });
                    }
                    e.wysiwyg.element
                      .querySelectorAll(".vditor-comment")
                      .forEach(function (e) {
                        e.getAttribute("data-cmtids").indexOf(s[0]) > -1 &&
                  ...
                  (0, y.lG)(n, "CODE")
                    ...
                    : g
                      ...
                      : v && m(e.toolbar.elements, ["table"]);
                  var w = (0, y.fb)(n, "vditor-toc");
                  if (w)
                    return (
                      (e.wysiwyg.popover.innerHTML = ""),
                      ue(w, e),
                  ...
                  if (
                    ...
                    var k = function () {
                          ...
                          "right" === n
                            ...
                            : "center" === n
                              ? (M.classList.remove("vditor-icon--current"),
                                ...
                                A.classList.add("vditor-icon--current"))
                              : (A.classList.remove("vditor-icon--current"),
                                x.classList.remove("vditor-icon--current"),
                      ...
                      C = "left";
                    L
                      ? (C = L.getAttribute("align") || "left")
                      : T && (C = T.getAttribute("align") || "center");
                    ...
                    (x.setAttribute("type", "button"),
                      ...
                      x.setAttribute("data-type", "right"),
                      (x.innerHTML =
                    ...
                    (J.appendChild(P),
                      ...
                      (P.onkeydown = function (n) {
                        if (!n.isComposing)
                          return "Tab" === n.key
                            ? (B.focus(), B.select(), void n.preventDefault())
                            : void (oe(e, n) || fe(n, t));
                      }));
                    ...
                    (q.appendChild(B),
                      ...
                      (B.onkeydown = function (n) {
                        if (!n.isComposing)
                          return "Tab" === n.key
                            ? (P.focus(), P.select(), void n.preventDefault())
                            : void (oe(e, n) || fe(n, t));
                      }),
                      ce(t, v, e),
                      de(t, v, e),
                  ...
                  var V = (0, y.a1)(n, "data-type", "link-ref");
                  V && se(e, V, t);
                  var U = (0, y.a1)(n, "data-type", "footnotes-ref");
                  if (U) {
                    (e.options.lang, e.options);
                    ((e.wysiwyg.popover.innerHTML = ""),
                      (J = document.createElement("span")).setAttribute(
                    ...
                    (J.appendChild(W),
                      ...
                      (W.oninput = function () {
                        ("" !== W.value.trim() &&
                          U.setAttribute("data-footnotes-label", W.value),
                          "function" == typeof e.options.input &&
                            e.options.input(a(e)));
                      }),
                  ...
                  var G = (0, y.fb)(n, "vditor-wysiwyg__block"),
                    z =
                      !!G && G.getAttribute("data-type").indexOf("block") > -1;
                  if (
                    (e.wysiwyg.element
                    ...
                    if (
                      ...
                      ((F.className = "vditor-input"),
                        ...
                        (F.value =
                          Z.className.indexOf("language-") > -1
                            ? Z.className.split("-")[1].split(" ")[0]
                            : ""),
                        (F.oninput = function (n) {
                          ("" !== F.value.trim()
                            ? (Z.className = "language-".concat(F.value))
                            : ((Z.className = ""),
                              (e.hint.recentLanguage = "")),
                            G.lastElementChild.classList.contains(
                              "vditor-wysiwyg__preview",
                            ) &&
                              ((G.lastElementChild.innerHTML =
                                G.firstElementChild.innerHTML),
                              N(G.lastElementChild, e)),
                            Q(e),
                            1 === n.detail &&
                              (t.setStart(Z.firstChild, 0),
                              t.collapse(!0),
                              (0, O.Hc)(t)));
                        }),
                        ...
                        e.wysiwyg.popover.insertAdjacentElement(
                          "beforeend",
                          K,
                        ));
                    }
                  ...
                  var $ = (0, y.a1)(t.startContainer, "data-type", "backslash");
          ...
          se = function (e, t, n) {
            ...
            var r = function () {
                ("" !== o.value.trim() &&
                  ...
                  "" !== s.value.trim() &&
                    t.setAttribute("data-link-label", s.value),
                  "function" == typeof e.options.input &&
                    e.options.input(a(e)));
              },
                ...
                s = (function (e) {
                  ...
                  return (
                    ...
                    (("" !== r.substr(o) && r.substr(o) !== i.g.ZWSP) || n) &&
                      (l = "".concat(r.substr(o)).concat(n)),
                    { afterHTML: l, beforeHTML: a }
                  );
                })(e),
                c = s.beforeHTML,
                d = s.afterHTML;
              ...
              if (
                ...
                ("0" !== r.parentElement.getAttribute("data-block") &&
                  ...
                  (("bold" === n && "STRONG" === u) ||
                    ("italic" === n && "EM" === u) ||
                    ("strikeThrough" === n && "S" === u)) &&
                    ((p += "".concat(a).concat(i.g.ZWSP, "<wbr>").concat(l)),
                    (o = !0)),
                  (d || f) &&
                    (p += d =
                      "<"
          ...
          ye = function (e, t) {
            ...
            if (2 === t.level)
              ...
              (s.setAttribute("data-type", t.name),
                (s.className = "vditor-tooltipped vditor-tooltipped__".concat(
                  t.tipPosition,
                )),
                              ...
                              if (t.classList.contains("vditor-menu--current"))
                                    ...
                                    s &&
                                      ...
                                      (s.outerHTML =
                                        "" === s.innerHTML.trim()
                                          ...
                                          : s.innerHTML),
                                      (0, O.ib)(e.wysiwyg.element, a)));
                                } else if ("inline-code" === l) {
                                  var c = (0, y.lG)(a.startContainer, "CODE");
                                  (c ||
                                    (c =
                                      a.startContainer.childNodes[
                                        a.startOffset
                                ...
                                if ("quote" === l) {
                                  ...
                                  if (u) {
                                    ...
                                    ("" === u.innerHTML.trim()
                                      ? (u.outerHTML = E)
                                      : u.insertAdjacentHTML("afterend", E),
                                      (0, O.ib)(e.wysiwyg.element, a));
                                  }
                                } else if (
                                  ((r = !1),
          ...
          we = function (e, t, n) {
            ...
            if (
              ("string" != typeof n
                ? (v(e, ["subToolbar", "hint"]), n.preventDefault(), (r = a(e)))
                : (r = n),
              ...
              (e.undo.resetIcon(e),
                "string" != typeof n &&
                  (e[e.currentMode].element.focus(), he(e)),
                D(e),
                K(e),
              ...
              (t.prototype._bindEvent = function (e, t, n) {
                ...
                (g(e, t, r, n.level),
                  ...
                  t.children
                    .item(1)
                    .addEventListener((0, c.Le)(), function (t) {
                      (we(e, "ir", t), t.preventDefault(), t.stopPropagation());
                    }),
                  t.children
                    .item(2)
                    .addEventListener((0, c.Le)(), function (t) {
                      (we(e, "sv", t), t.preventDefault(), t.stopPropagation());
                    }));
              }),
              t
            );
          ...
          ke = function (e, t) {
            return (0, O.Gb)(e, t) ? getSelection().toString() : "";
          },
          Se = function (e, t) {
          ...
          Te = function (e, t) {
            t.addEventListener("blur", function (t) {
              if ("ir" === e.currentMode) {
                ...
                "wysiwyg" !== e.currentMode ||
                  e.wysiwyg.selectPopover.contains(t.relatedTarget) ||
                  e.wysiwyg.hideComment();
              ((e[e.currentMode].range = (0, O.zh)(e)),
              ...
              if (
                ...
                if (
                  ...
                  if (
                    (function (e, t) {
                      ...
                      3 !== l.startContainer.nodeType &&
                        ...
                        (s = l.startContainer.childNodes[l.startOffset - 1]);
                      var d = (0, y.a1)(s, "data-type", "text"),
                      ...
                      if (
                        ...
                        var h = (0, O.im)(f, e.sv.element, l).start,
                        ...
                        if (
                          ...
                          if (
                            ...
                            return (
                              "padding" ===
                              (null === (r = g.previousElementSibling) ||
                              void 0 === r
                                ? void 0
                                : r.getAttribute("data-type"))
                                ? (g.previousElementSibling.remove(), U(e))
                                : (v &&
                                    (g.remove(),
                          ...
                          if ("Tab" === t.key)
                            return (
                              t.shiftKey
                                ? "padding" ===
                                    g.previousElementSibling.getAttribute(
                                      "data-type",
                                    ) && g.previousElementSibling.remove()
                              ...
                              /^\d/.test(g.textContent) &&
                                ((g.textContent = g.textContent.replace(
                                  /^\d{1,}/,
                                  "1",
                                )),
                      ...
                      if (
                        ...
                        (0, O.im)(w, e.sv.element).start <=
                          (S ? S[0].length : 0) && (k = !0);
                        var L = "\n";
                        if (E) {
                          if (
                            "enter-remove" ===
                            (null === (i = E.previousElementSibling) ||
                            void 0 === i
                              ? void 0
                        ...
                        return (
                          l.insertNode(document.createTextNode(L)),
                          l.collapse(!1),
                      ...
                      if (
                        ...
                        if (
                          ...
                          1 === (0, O.im)(E, e.sv.element, l).start &&
                          -1 ===
                            E.getAttribute("data-type").indexOf("code-block-")
                        )
                          return (
                            l.setStart(E, 0),
                            l.extractContents(),
                        ...
                        if (
                          ...
                          return (
                            ...
                            void 0 === a
                              ...
                              ? ("newline" !== T.getAttribute("data-type") &&
                                  (l.selectNodeContents(T.lastChild),
                                  l.collapse(!1)),
                                je(e))
                              : U(e),
                            t.preventDefault(),
                  ...
                  if (
                    (function (e, t) {
                      ...
                      var o = (0, y.F9)(r),
                        a = (0, y.lG)(r, "P");
                      if (mt(t, e, a, n)) return !0;
                      if (ut(n, e, a, t)) return !0;
                      if (bt(e, t, n)) return !0;
                      ...
                      if (l) {
                        ...
                        if (
                          ...
                          t.altKey &&
                          "Enter" === t.key &&
                          "code-block" === l.getAttribute("data-type")
                        ) {
                          var s =
                        ...
                        if ("0" === l.getAttribute("data-block")) {
                          if (wt(e, t, l.firstElementChild, n)) return !0;
                          if (nt(e, t, n, l.firstElementChild, l)) return !0;
                          if (
                            "yaml-front-matter" !==
                              l.getAttribute("data-type") &&
                            rt(e, t, n, l.firstElementChild, l)
                          )
                            return !0;
                        }
                      }
                      if (Et(e, n, t, a)) return !0;
                      var d = (0, y.E2)(r, "BLOCKQUOTE");
                      ...
                      if (
                        ...
                        if (o) {
                          if (
                            ...
                            var k = (0, O.im)(o, e.wysiwyg.element, n).start;
                            if (
                              (0 === k && 0 === n.startOffset) ||
                          ...
                          if (
                            "" === n.toString() &&
                            3 === r.nodeType &&
                            "\n" === r.textContent.charAt(S - 2) &&
                            r.textContent.charAt(S - 1) !== i.g.ZWSP &&
                            ["STRONG", "STRIKE", "S", "I", "EM", "B"].includes(
                              r.parentElement.tagName,
                            )
                          )
                            return (
                              (r.textContent =
                                r.textContent.substring(0, S - 1) + i.g.ZWSP),
                              n.setStart(r, S),
                              n.collapse(!0),
                              Q(e),
                              t.preventDefault(),
                      ...
                      if (Tt(t, o, n)) return (t.preventDefault(), !0);
                      if ((Ye(n, t.key), "ArrowDown" === t.key)) {
                        var L = r.nextSibling;
                        L &&
                          3 !== L.nodeType &&
                          "math-inline" === L.getAttribute("data-type") &&
                          n.setStartAfter(L);
                      }
                  ...
                  (function (e, t) {
                    ...
                    if (
                      ...
                      var l = o.nextSibling;
                      l &&
                        (n.insertNode(document.createTextNode(l.textContent)),
                        n.collapse(!0));
                    }
                    var s = (0, y.lG)(r, "P");
                    if (mt(t, e, s, n)) return !0;
                    if (ut(n, e, s, t)) return !0;
                    if (Et(e, n, t, s)) return !0;
                    var d = (0, y.fb)(r, "vditor-ir__marker--pre");
                    if (d && "PRE" === d.tagName) {
                      var u = d.firstChild;
                      if (wt(e, t, d, n)) return !0;
                      if (
                        ("math-block" === u.getAttribute("data-type") ||
                          "html-block" === u.getAttribute("data-type")) &&
                        rt(e, t, n, u, d.parentElement)
                      )
                        return !0;
                    ...
                    if (p) {
                      ...
                      if ("Backspace" === t.key) {
                        var m = (0, O.im)(p, e.ir.element).start;
                        (1 === m && n.setStart(r, 0),
                    ...
                    if (t.key.indexOf("Arrow") > -1 && f) {
                      var h = $e(f);
                      if (h && rt(e, t, n, f, h)) return !0;
                      var g = et(f);
                      if (g && nt(e, t, n, f, g)) return !0;
                    }
                    if (bt(e, t, n)) return !0;
                    if (kt(e, n, t)) return !0;
                    if (pt(e, n, t)) return !0;
                    ...
                    if (
                      ...
                      if (
                        ...
                        var S = (0, O.im)(k, e.ir.element, n).start;
                        if (
                          0 === S ||
                          (1 === S && k.innerText.startsWith(i.g.ZWSP))
                        )
                          return (
                      ...
                      if (w) {
                        ...
                        (0, O.im)(w, e.ir.element).start === L &&
                          (n.setStart(w.firstElementChild.firstChild, L - 1),
                          n.collapse(!0),
                          (0, O.Hc)(n));
                      }
                    }
                    return !(
                      (("ArrowUp" !== t.key && "ArrowDown" !== t.key) ||
                        ...
                        !Tt(t, k, n))) &&
                      (Ye(n, t.key),
                      !k || !j(k, e, t, n) || (t.preventDefault(), 0))
                    );
                  })(e, t)
                )
                  return;
                ...
                if (
                  ...
                  if ("wysiwyg" === e.currentMode) {
                    ...
                    ((0, y.lG)(getSelection().getRangeAt(0).startContainer, n)
                      ? re(e)
                      : ne(e, n),
                      Q(e));
                  } else
              ...
              t.onmouseup = function () {
                setTimeout(function () {
                  ...
                  t.trim()
                    ? ("wysiwyg" === e.currentMode &&
                        e.options.comment.enable &&
                        ((0, y.a1)(n.target, "data-type", "footnotes-block") ||
                        (0, y.a1)(n.target, "data-type", "link-ref-defs-block")
                          ? e.wysiwyg.hideComment()
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    var l = Oe(e, "code-block-open-marker");
                    l &&
                      l.previousElementSibling &&
                      ((n = l.previousElementSibling), (r = a + r));
                  } else r = a + r;
                  ...
                  (s =
                    "" === i.toString()
                      ...
                      : ""
                          ...
                          .concat(Lute.Caret)
                          .concat("code" === o ? "" : r)),
                  "table" === o || ("code" === o && l && "" !== l.textContent)
                    ? (s = "\n\n" + s)
                    : "line" === o &&
                      (s = "\n\n".concat(n, "\n").concat(Lute.Caret)),
                  void document.execCommand("insertHTML", !1, s)
          ...
          Ge = function (e, t, n) {
            return Ve(void 0, void 0, void 0, function () {
              var r, i, o, a, l, s, c, d, u, p, m, f, h, v;
                ...
                switch (g.label) {
                  ...
                  case 4:
                    ...
                    if (
                      ...
                      (s = (function (e, t) {
                        ...
                        for (
                          ...
                          o(0, l);
                        return (
                          e.tip.show("<ul>".concat(r).concat(i, "</ul>")),
                          n
                        );
                      })(e, r)),
                      0 === s.length)
                    ...
                    for (f = 0, h = s.length; f < h; f++)
                      c.append(e.options.upload.fieldName, s[f]);
                    return (
                      (v = new XMLHttpRequest()).open(
                        "POST",
                        ...
                        if (v.readyState === XMLHttpRequest.DONE) {
                          if (
                            ...
                            if (e.options.upload.success)
                              ...
                              (e.options.upload.format &&
                                ...
                                (function (e, t) {
                                  ...
                                  var i = "";
                                  (Object.keys(n.data.succMap).forEach(
                                    function (e) {
                            ...
                            e.options.upload.error
                              ? e.options.upload.error(v.responseText)
                              : e.tip.show(v.responseText);
                          (n && (n.value = ""),
          ...
          ze = function (e, t, n) {
            ...
            if (
              ...
              var s,
                ...
                d = (0, y.a1)(o, "data-type", "footnotes-block");
              if (c) l = o.innerHTML;
              else {
                ...
                if (
                  ...
                  (!m ||
                    ...
                    ((l = m.outerHTML + l), m.remove()),
                    !f ||
                      ("UL" !== f.tagName && "OL" !== f.tagName) ||
                      ((l += f.outerHTML), f.remove()),
                    (l = l.replace(
                      "<div><wbr><br></div>",
                      "<li><p><wbr><br></p></li>",
                    )));
              ...
              if (
                ('<p data-block="0">```<wbr></p>' ===
                  ...
                  e.hint.recentLanguage &&
                  (l = '<p data-block="0">```<wbr></p>'.replace(
                    "```",
                    "```" + e.hint.recentLanguage,
                  )),
                ...
                o.innerHTML = l;
              else if (((o.outerHTML = l), d)) {
                var h = (0, y.E2)(e.wysiwyg.element.querySelector("wbr"), "LI");
                if (h) {
                  var v = e.wysiwyg.element.querySelector(
                    'sup[data-type="footnotes-ref"][data-footnotes-label="'.concat(
              ...
              var g,
                E = e.wysiwyg.element.querySelectorAll(
                  "[data-type='link-ref-defs-block']",
                );
              (E.forEach(function (e, t) {
                ...
                E.length > 0 &&
                  e.wysiwyg.element.insertAdjacentElement("beforeend", E[0]));
              var k = e.wysiwyg.element.querySelectorAll(
                "[data-type='footnotes-block']",
              );
              (k.forEach(function (e, t) {
                ...
                k.length > 0 &&
                  e.wysiwyg.element.insertAdjacentElement("beforeend", k[0]),
                (0, O.ib)(e.wysiwyg.element, t),
                e.wysiwyg.element
                  .querySelectorAll(".vditor-wysiwyg__preview[data-render='2']")
                  .forEach(function (t) {
          ...
          Xe = function (e, t, n) {
            if (
              ...
              var r =
                (0, y.lG)(e.startContainer, "P") ||
                (0, y.lG)(e.startContainer, "LI");
              if (r && 0 === (0, O.im)(r, t[t.currentMode].element, e).start) {
                r.nodeValue &&
          ...
          Ye = function (e, t) {
            if ("ArrowDown" === t || "ArrowUp" === t) {
              var n =
                (0, y.a1)(e.startContainer, "data-type", "math-inline") ||
                (0, y.a1)(e.startContainer, "data-type", "html-entity") ||
                (0, y.a1)(e.startContainer, "data-type", "html-inline");
              n &&
          ...
          Qe = function (e, t) {
            ...
            r &&
              ...
              (0, O.ib)(e[e.currentMode].element, n),
              he(e),
              dt(e));
          },
          $e = function (e) {
              ...
              r ||
                (r = e.parentElement.previousElementSibling
                  ...
                  : "TBODY" === e.parentElement.parentElement.tagName &&
                    ...
                    : null),
              r && (t.selectNodeContents(r), n || t.collapse(!1), (0, O.Hc)(t)),
              r
            );
          },
          nt = function (e, t, n, r, o) {
            var a = (0, O.im)(r, e[e.currentMode].element, n);
            if (
              ("ArrowDown" === t.key &&
                -1 ===
              ...
              return (
                !l ||
                (l && ("TABLE" === l.tagName || l.getAttribute("data-type")))
                  ? (o.insertAdjacentHTML(
                      "afterend",
                      '<p data-block="0">'.concat(i.g.ZWSP, "<wbr></p>"),
                    ),
                    (0, O.ib)(e[e.currentMode].element, n))
                  : (n.selectNodeContents(l), n.collapse(!0), (0, O.Hc)(n)),
                t.preventDefault(),
                !0
              );
            }
              ...
              return (
                ...
                (l && ("TABLE" === l.tagName || l.getAttribute("data-type")))
                  ? (o.insertAdjacentHTML(
                    ...
                    (0, O.ib)(e[e.currentMode].element, n))
                  : (n.selectNodeContents(l), n.collapse(!1), (0, O.Hc)(n)),
                t.preventDefault(),
                !0
              );
            }
          ...
          it = function (e, t, n, r) {
            ...
            if (
              ...
              if ("check" === n)
                ...
                var s = void 0;
                ("list" === n
                  ? (s = document.createElement("ul")).setAttribute(
                      "data-marker",
                      "*",
                    )
                  : (s = document.createElement("ol")).setAttribute(
                      "data-marker",
                      "1.",
                    ),
              ...
              var c = (0, y.a1)(t.startContainer, "data-block", "0");
              (c ||
            ...
            if (i) {
              ...
              Array.from(n.cloneContents().children).forEach(function (e, n) {
                3 !== e.nodeType &&
                  ...
                  t.getAttribute("data-node-id") ===
                    e.getAttribute("data-node-id") &&
                  (0 !== n && l.push(t), (t = t.nextElementSibling));
              });
              var s = !1,
                c = "";
            ...
            if (l) {
              ...
              if (
                !(
                  ...
                  l.previousElementSibling ||
                  "" !== e.toString() ||
                  0 !== (0, O.im)(l, t[t.currentMode].element, e).start
                )
              )
                return (
                  l.nextElementSibling
                    ? (l.parentElement.insertAdjacentHTML(
                        "beforebegin",
                        '<p data-block="0"><wbr>'.concat(l.innerHTML, "</p>"),
                      ),
                      l.remove())
                    : (l.parentElement.outerHTML =
                        '<p data-block="0"><wbr>'.concat(l.innerHTML, "</p>")),
                  (0, O.ib)(t[t.currentMode].element, e),
                  dt(t),
                  r.preventDefault(),
                  !0
                );
              if (
                ...
                !r.altKey &&
                "Backspace" === r.key &&
                "" === l.textContent.trim().replace(i.g.ZWSP, "") &&
                "" === e.toString() &&
                "LI" ===
                  (null === (o = l.previousElementSibling) || void 0 === o
                    ? void 0
                    : o.tagName)
              )
                return (
                  l.previousElementSibling.insertAdjacentText(
                    "beforeend",
                    "\n\n",
                  ),
              ...
              if (!(0, c.yl)(r) && !r.altKey && "Tab" === r.key) {
                ...
                if (
                  ...
                  return (
                    r.shiftKey ? at(t, l, e, l.parentElement) : ot(t, l, e),
                    r.preventDefault(),
                    !0
                  );
              }
          ...
          mt = function (e, t, n, r) {
            if (n) {
              if (!(0, c.yl)(e) && !e.altKey && "Enter" === e.key) {
                ...
                if (i.startsWith("|") && i.endsWith("|") && o.length > 3) {
                  ...
                  return (
                    ...
                    (0, O.ib)(t[t.currentMode].element, r),
                    dt(t),
                    xe(t),
                    e.preventDefault(),
                    !0
                ...
                if (st(n.innerHTML) && n.previousElementSibling) {
                  ...
                  return (
                    s.length > 1 &&
                      (s.pop(),
                      (l = '<p data-block="0">'.concat(s.join("\n"), "</p>"))),
              ...
              if (
                ...
                0 === (0, O.im)(n, t[t.currentMode].element, r).start
              ) {
                var d = (0, y.DX)(n.previousElementSibling);
                return (
          ...
          bt = function (e, t, n) {
            ...
            if (i) {
                  ...
                  : ((u = i.nextElementSibling) ||
                      (u = i.parentElement.nextElementSibling
                        ...
                        : "THEAD" === i.parentElement.parentElement.tagName &&
                          ...
                          : null),
                    u && (n.selectNodeContents(u), (0, O.Hc)(n)),
                    t.preventDefault(),
                    !0);
              ...
              if ("ArrowUp" === t.key) {
                ...
                for (
                  var l = 0, s = i.parentElement;
                  l < s.cells.length && !s.cells[l].isSameNode(i);
                  l++
                );
                var d = s.previousElementSibling;
                return (
                  d || (d = s.parentElement.previousElementSibling.firstChild),
              ...
              if ("ArrowDown" === t.key) {
                ...
                if (
                  (t.preventDefault(),
                  !(s = i.parentElement).nextElementSibling &&
                    "TD" === i.tagName)
                )
                  return (
                ...
                return (
                  (u = s.nextElementSibling) ||
                    (u = s.parentElement.nextElementSibling.firstChild),
              ...
              if (P("⇧⌘F", t)) return (ht(e, n, i), t.preventDefault(), !0);
              if (P("⌘=", t)) return (ft(e, n, i), t.preventDefault(), !0);
              if (P("⇧⌘G", t))
                return (vt(e, a, i, "beforebegin"), t.preventDefault(), !0);
              if (P("⇧⌘=", t)) return (vt(e, a, i), t.preventDefault(), !0);
              if (P("⌘-", t)) return (gt(e, n, i), t.preventDefault(), !0);
              if (P("⇧⌘-", t)) return (yt(e, n, a, i), t.preventDefault(), !0);
              if (P("⇧⌘L", t)) {
                if ("ir" === e.currentMode)
                  return (lt(a, "left"), dt(e), t.preventDefault(), !0);
                if ((m = e.wysiwyg.popover.querySelector('[data-type="left"]')))
                  return (m.click(), t.preventDefault(), !0);
              }
              if (P("⇧⌘C", t)) {
                if ("ir" === e.currentMode)
                  return (lt(a, "center"), dt(e), t.preventDefault(), !0);
                if (
              ...
              if (P("⇧⌘R", t)) {
                if ("ir" === e.currentMode)
                  return (lt(a, "right"), dt(e), t.preventDefault(), !0);
                var m;
                if (
          ...
          wt = function (e, t, n, r) {
            ...
            if (
              ...
              var i = (0, O.im)(n, e[e.currentMode].element, r);
              if (
                (0 === i.start || (1 === i.start && "\n" === n.innerText)) &&
                "" === r.toString()
              )
                return (
                  ...
                  (0, O.ib)(e[e.currentMode].element, r),
                  dt(e),
                  t.preventDefault(),
                  !0
                );
            ...
            return (
              ...
              r.collapse(!1),
              (0, O.Hc)(r),
              (0, c.vU)() || ("wysiwyg" === e.currentMode ? ze(e, r) : R(e, r)),
              xe(e),
              t.preventDefault(),
              !0)
            );
          ...
          Et = function (e, t, n, r) {
            ...
            if (a && "" === t.toString()) {
              if (
                ...
                !n.shiftKey &&
                !n.altKey &&
                0 === (0, O.im)(a, e[e.currentMode].element, t).start
              )
                return (
                  t.insertNode(document.createElement("wbr")),
                  (a.outerHTML = a.innerHTML),
                  (0, O.ib)(e[e.currentMode].element, t),
                  dt(e),
                  n.preventDefault(),
                  !0
                );
                ...
                if (
                  ...
                  "" === r.innerHTML.replace(i.g.ZWSP, "")
                    ...
                    : r.innerHTML.endsWith("\n\n") &&
                      (0, O.im)(r, e[e.currentMode].element, t).start ===
              ...
              if ("wysiwyg" === e.currentMode && s && P("⇧⌘;", n))
                return (
                  t.insertNode(document.createElement("wbr")),
                  (s.outerHTML = '<blockquote data-block="0">'.concat(
                    s.outerHTML,
                    "</blockquote>",
                  )),
                  (0, O.ib)(e.wysiwyg.element, t),
            ...
            if (i) {
              ...
              if (
                ...
                if ((i.querySelector("input").remove(), a))
                  ((0, y.DX)(a).parentElement.insertAdjacentHTML(
                    "beforeend",
          ...
          St = function (e, t, n, r) {
            ...
            if (r) {
              ...
              if (
                o &&
                0 === (0, O.im)(r, e[e.currentMode].element, t).start &&
          ...
          Ct = function (e, t, n) {
            return Fe(void 0, void 0, void 0, function () {
              var r, o, a, l, s, c, d, u, p, m, f, h, v, g, b, w;
              return Ze(this, function (E) {
                switch (E.label) {
                  case 0:
                    return "true" !==
                      ...
                      : (t.stopPropagation(),
                        ...
                        (p =
                          "sv" === e.currentMode
                            ? (0, y.a1)(t.target, "data-type", "code-block")
                            : (0, y.lG)(t.target, "CODE"))
                          ? ("sv" === e.currentMode
                              ? document.execCommand(
                                  "insertHTML",
                                  !1,
                  ...
                  case 2:
                    return "" === r.trim()
                      ...
                      : (((f = document.createElement("div")).innerHTML = r),
                        ...
                        "ir" === e.currentMode
                          ? ((l.HTML2VditorIRDOM = { renderLinkDest: s }),
                            e.lute.SetJSRenderers({ renderers: l }),
                            (0, O.oC)(e.lute.HTML2VditorIRDOM(f.innerHTML), e))
                          : "wysiwyg" === e.currentMode
                            ? ((l.HTML2VditorDOM = { renderLinkDest: s }),
                              e.lute.SetJSRenderers({ renderers: l }),
                              (0, O.oC)(e.lute.HTML2VditorDOM(f.innerHTML), e))
                            : ((l.Md2VditorSVDOM = { renderLinkDest: s }),
                              e.lute.SetJSRenderers({ renderers: l }),
                  ...
                  case 5:
                    ((h = new FileReader()),
                      "clipboardData" in t
                        ? ((a = t.clipboardData.files), (v = a[0]))
                        : t.dataTransfer.types.includes("Files") &&
                          ((a = t.dataTransfer.items), (v = a[0].getAsFile())),
                      v &&
                  ...
                  case 7:
                    ("" !== o.trim() &&
                      ...
                      ("" !== (b = (0, O.zh)(e)).toString() &&
                        ...
                        (o = "[".concat(b.toString(), "](").concat(o, ")")),
                      "ir" === e.currentMode
                        ? ((l.Md2VditorIRDOM = { renderLinkDest: s }),
                          e.lute.SetJSRenderers({ renderers: l }),
                          (0, O.oC)(e.lute.Md2VditorIRDOM(o), e))
                        : "wysiwyg" === e.currentMode
                          ? ((l.Md2VditorDOM = { renderLinkDest: s }),
                            e.lute.SetJSRenderers({ renderers: l }),
                            (0, O.oC)(e.lute.Md2VditorDOM(o), e))
                          : ((l.Md2VditorSVDOM = { renderLinkDest: s }),
                            e.lute.SetJSRenderers({ renderers: l }),
                            Ne(e, o)),
                      e.outline.render(e)),
                  ...
                  case 8:
                    return (
                      "sv" !== e.currentMode &&
                        ((g = (0, y.F9)((0, O.zh)(e).startContainer)) &&
                          ((b = (0, O.zh)(e)),
                          e[e.currentMode].element
                            .querySelectorAll("wbr")
                            .forEach(function (e) {
                          ...
                          "wysiwyg" === e.currentMode
                            ? (g.outerHTML = e.lute.SpinVditorDOM(g.outerHTML))
                            : (g.outerHTML = e.lute.SpinVditorIRDOM(
                                g.outerHTML,
                              )),
                          (0, O.ib)(e[e.currentMode].element, b)),
                        e[e.currentMode].element
                          .querySelectorAll(
                            ".vditor-".concat(
                              e.currentMode,
            ...
            if (n)
              if (
                ...
                ((n.textContent = i.g.ZWSP + e.hint.recentLanguage),
                  (0, O.zh)(e).selectNodeContents(n));
              } else {
                var r = [],
                  o = n.textContent
                    .substring(0, (0, O.im)(n, e.ir.element).start)
                    .replace(i.g.ZWSP, "");
          ...
          Ht = function (e, t, n, r) {
            ...
            if (t.classList.contains("vditor-menu--current"))
              if ("quote" === o) {
                ...
                s &&
                  ...
                  (s.outerHTML =
                    "" === s.innerHTML.trim()
                      ? '<p data-block="0">'.concat(s.innerHTML, "</p>")
                      : s.innerHTML));
              } else if ("link" === o) {
                var c = (0, y.a1)(i.startContainer, "data-type", "a");
                if (c) {
            ...
            ((0, O.ib)(e.ir.element, i), At(e), l && Y(e));
          },
          Nt = function (e, t, n, r) {
            return new (n || (n = Promise))(function (i, o) {
              function a(e) {
                ...
                (this.fillEmoji = function (e, n) {
                  ...
                  if (
                    ...
                    var l = o.startContainer,
                      s = void 0;
                    if (
                      (s = l.classList.contains("vditor-input")
                        ? l
                        : l.firstElementChild) &&
                  ...
                  if (
                    ...
                    n.options.hint.parse
                      ? "sv" === n.currentMode
                        ? (0, O.oC)(n.lute.SpinVditorSVDOM(r), n)
                        : "wysiwyg" === n.currentMode
                          ? (0, O.oC)(n.lute.SpinVditorDOM(r), n)
                          : (0, O.oC)(n.lute.SpinVditorIRDOM(r), n)
                      : (0, O.oC)(r, n),
                    ":" === t.splitChar &&
                      r.indexOf(":") > -1 &&
                      "sv" !== n.currentMode &&
                ...
                if (0 !== e.length) {
                  ...
                  (e.forEach(function (e, n) {
                    if (!(n > 7)) {
                      ...
                      s += '<button type="button" data-value="'
                  ...
                  ((this.element.style.top = "".concat(l + (c || 22), "px")),
              ...
              (e.prototype.bindEvent = function (e) {
                ...
                (this.element.addEventListener("paste", function (t) {
                  ...
                  this.element.addEventListener("compositionend", function (n) {
                    ((0, c.vU)() ||
                      R(e, getSelection().getRangeAt(0).cloneRange()),
                      (t.composingLock = !1));
                  }),
                  ...
                  this.element.addEventListener("click", function (n) {
                    ...
                    if (
                      (o ||
                        (o = (0, y.fb)(r.startContainer, "vditor-ir__preview")),
                      o &&
                    ...
                    if (!l || l.classList.contains("vditor-ir__node--expand")) {
                      ...
                      e.options.link.click
                        ...
                        : e.options.link.isOpen &&
                          window.open(
                            l.querySelector(":scope > .vditor-ir__marker--link")
                              .textContent,
                          );
                  }),
                      ...
                      if (
                        ...
                        "Backspace" === n.key
                          ? ((0, c.vU)() &&
                              ...
                              1 === r.startOffset &&
                              ((r.startContainer.textContent = ""), q(r, e)),
                            t.element
            ...
            return (
              ...
              (e.prototype.afterRender = function (e, t) {
                ...
                (r && r.classList.remove("vditor-comment--focus"),
                  (0, S.O)(e.preview.previewElement, e.options.preview.hljs),
                  (0, C.s)(
                  ...
                  (0, L.P)(e.preview.previewElement, e.options.cdn),
                  (0, T.v)(e.preview.previewElement, e.options.cdn),
                  (0, k.p)(
                    e.preview.previewElement,
                    e.options.cdn,
                    e.options.theme,
                  ...
                  (0, H.B)(e.preview.previewElement, e.options.cdn),
                  (0, E.Q)(e.preview.previewElement, e.options.cdn),
                  e.options.preview.render.media.enable &&
                    (0, Bt.Y)(e.preview.previewElement),
                ...
                ("" === o && (o = "[ToC]"),
                  ...
                  (0, M.H)(e.preview.previewElement, {
                    cdn: e.options.cdn,
                    math: e.options.preview.math,
                  }));
              }),
                      ...
                      ("top" === e.options.resize.position
                        ...
                        e.options.typewriterMode &&
                          (e.sv.element.style.paddingBottom =
                            e.sv.element.parentElement.offsetHeight / 2 +
                            "px"));
                    }),
            ...
            return (
              ...
              (e.prototype.bindEvent = function (e) {
                ...
                (this.element.addEventListener("paste", function (t) {
                  ...
                  this.element.addEventListener("compositionend", function (n) {
                    ((0, c.vU)() || U(e, n), (t.composingLock = !1));
                  }),
                  this.element.addEventListener("input", function (n) {
                    if (
                      "deleteByDrag" !== n.inputType &&
              ...
              return (
                ...
                a.addEventListener((0, c.Le)(), function (e) {
                  "BUTTON" === e.target.tagName &&
                    ...
                    (0, Jt.Y)(e.target.textContent, t.options.cdn),
                    e.preventDefault(),
                    e.stopPropagation());
                }),
                  ...
                  function (n) {
                    ...
                    if (r) {
                      ...
                      if (
                        ...
                        ((l.innerHTML = a),
                          (a =
                            l.firstElementChild.firstElementChild.outerHTML +
                            " "),
                          (0, O.oC)(a, e));
                      } else
                        (o.extractContents(),
                    ...
                    n.classList.contains(i.g.CLASS_MENU_DISABLED) ||
                      ...
                      n.classList.contains("vditor-menu--current")
                        ? ("wysiwyg" === e.currentMode
                          ...
                          n.classList.remove("vditor-menu--current"))
                        : (v(e, ["subToolbar"]), (t.style.display = "block"))));
                });
                for (var r = 0; r < 6; r++)
                  t.children
                    .item(r)
                    .addEventListener((0, c.Le)(), function (r) {
                      (r.preventDefault(),
                        "wysiwyg" === e.currentMode
                          ? (ne(e, r.target.getAttribute("data-tag")),
                            Q(e),
                            n.classList.add("vditor-menu--current"))
                          : "ir" === e.currentMode
                            ? (xt(e, r.target.getAttribute("data-value")),
                              n.classList.add("vditor-menu--current"))
                            : Re(e, r.target.getAttribute("data-value")),
                        (t.style.display = "none"));
                    });
              }),
              t
          ...
          Nn = (function () {
            ...
            return (
              ...
              (e.prototype.buildWavFileBlob = function () {
                ...
                for (var s = n.length, c = 44, d = 0; d < s; d++)
              ...
              (e.prototype.downSampleBuffer = function (e, t) {
                ...
                for (
                  ...
                  for (
                    var l = Math.round((o + 1) * n), s = 0, c = 0, d = a;
                    d < l && d < e.length;
                    d++
                  )
                    ((s += e[d]), c++);
                    ...
                    if (
                      ...
                      if (t)
                        ...
                        navigator.mediaDevices
                          ...
                          .then(function (r) {
                            (((t = new Nn(r)).recorder.onaudioprocess =
                              function (e) {
                                if (t.isRecording) {
              ...
              (e.prototype.merge = function () {
                ...
                this.options &&
                  ...
                  this.options.cdn &&
                    ...
                    (null === (s = this.options.hint) || void 0 === s
                      ? void 0
                      : s.emojiPath) ||
                ...
                var c = (0, Gn.T)(this.defaultOptions, this.options);
                ...
                (this.unbindListener(),
                  ...
                  this.element.addEventListener("compositionend", function (n) {
                    ...
                    r && "" === r.textContent
                      ? D(e)
                      : ((0, c.vU)() ||
                          ze(e, getSelection().getRangeAt(0).cloneRange(), n),
                        (t.composingLock = !1));
                  }),
                  this.element.addEventListener("input", function (n) {
                    if (
                      ...
                      if (t.preventInput)
                        return ((t.preventInput = !1), void Q(e));
                      if (
                        t.composingLock ||
                        "‘" === n.data ||
                        "“" === n.data ||
                        ...
                        if (
                          (i || (te(e, r), (i = (0, y.F9)(r.startContainer))),
                          i)
                        ) {
                          for (
                            var o = (0, O.im)(i, e.wysiwyg.element, r).start,
                              l = !0,
                              s = o - 1;
                          ...
                          (d && "" === d.textContent && (D(e), d.remove()),
                            (l &&
                              "code-block" !== i.getAttribute("data-type")) ||
                            c ||
                            ct(i.innerHTML) ||
                            (st(i.innerHTML) && i.previousElementSibling)
                              ? "function" == typeof e.options.input &&
                                e.options.input(a(e))
                  ...
                  this.element.addEventListener("click", function (n) {
                    ...
                    if (
                        ...
                        n.y > s.top + s.height &&
                          ...
                          "" ===
                            t.element.lastElementChild.textContent
                              .trim()
                              .replace(i.g.ZWSP, "")
                            ? (l.selectNodeContents(t.element.lastElementChild),
                              l.collapse(!1))
                            : (t.element.insertAdjacentHTML(
                                "beforeend",
                                '<p data-block="0">'.concat(
                      ...
                      ae(e);
                      var c = (0, y.fb)(n.target, "vditor-wysiwyg__preview");
                      (c ||
                        (c = (0, y.fb)(
                          (0, O.zh)(e).startContainer,
                          "vditor-wysiwyg__preview",
                        )),
                        c && ie(c, e),
                        I(n, e));
          ...
          function t(t, n) {
            ...
            if (((r.version = i.H), "string" == typeof t)) {
              if (
                ...
                return (
                  r.showErrorTip("Failed to get element by id: ".concat(t)),
                  r
                );
          ...
          return (
            ...
            (t.prototype.setTheme = function (e, t, n, r) {
              ((this.vditor.options.theme = e),
                ...
                t &&
                  ...
                  (0, W.Z)(t, r || this.vditor.options.preview.theme.path)),
                n &&
                  ((this.vditor.options.preview.hljs.style = n),
                  (0, Jt.Y)(n, this.vditor.options.cdn)));
            }),
            ...
            (t.prototype.getSelection = function () {
              return "wysiwyg" === this.vditor.currentMode
                ? ke(this.vditor.wysiwyg.element)
                : "sv" === this.vditor.currentMode
                  ? ke(this.vditor.sv.element)
                  : "ir" === this.vditor.currentMode
                    ? ke(this.vditor.ir.element)
                    : void 0;
            }),
            ...
            (t.prototype.getCursorPosition = function () {
              return (0, O.Ny)(this.vditor[this.vditor.currentMode].element);
            }),
            ...
            (t.prototype.insertValue = function (e, t) {
              ...
              ((r.innerHTML = e),
                ...
                n.collapse(!1),
                "sv" === this.vditor.currentMode
                  ? ((this.vditor.sv.preventInput = !0), t && U(this.vditor))
                  : "wysiwyg" === this.vditor.currentMode
                    ? t && ze(this.vditor, getSelection().getRangeAt(0))
                    : "ir" === this.vditor.currentMode &&
            ...
            (t.prototype.setValue = function (e, t) {
              ...
              (void 0 === t && (t = !1),
                  ...
                  : "wysiwyg" === this.vditor.currentMode
                    ...
                    : ((this.vditor.ir.element.innerHTML =
                      ...
                      this.vditor.ir.element
                        .querySelectorAll(
                          ".vditor-ir__preview[data-render='2']",
                        )
                        .forEach(function (e) {
                          N(e, n.vditor);
                        }),
                ...
                e ||
                  (v(this.vditor, ["emoji", "headings", "submenu", "hint"]),
